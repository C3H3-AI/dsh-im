  ...
  return h2(
    ...
    h2(
      ...
      h2(
        ...
        h2("div", { className: "ddt-summary dim-cardSummary" }, account.error?.message ?? account.health.summary),
        h2(
          "div",
...
function Heading2({ totals, onAdd, adding, busy, addButtonRef }) {
  ...
  return h3(
    ...
    h3(
      ...
      }, h3("span", null, `${totals.connected} / ${totals.configured} \u5728\u7EBF`)) : null
    )
  );
}
function LoadingView2() {
  return h3(
    ...
    h3("div", { className: "dim-spinner", "aria-hidden": "true" }),
    h3("span", null, "\u6B63\u5728\u8BFB\u53D6\u98DE\u4E66\u8FDE\u63A5\u72B6\u6001\u2026")
  );
}
    ...
    h3(
      ...
      h3(
        ...
        h3(
          ...
          h3("span", { className: "bxf-dot dim-stateDot" }),
      ...
      h3("div", { className: "bxf-markStage dim-emptyBrand", "aria-hidden": "true" }, h3(BrandMark))
    )
  );
}
    ...
    h3(
      ...
      h3(
        ...
        h3(
          "div",
          { className: "bxf-stateLabel dim-stateLabel" },
          h3("span", { className: "bxf-dot dim-stateDot", "data-tone": "warning" }),
        ...
        h3(
          ...
          }, h3("span", null, "\u5728\u98DE\u4E66\u4E2D\u6253\u5F00")) : null,
          !expired ? h3(Button3, { onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
...
function LoadingView3() {
  return h4(
    "div",
    { className: "ddt-card ddt-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" },
    h4("div", { className: "ddt-spinner dim-spinner" }),
    h4("span", null, "\u6B63\u5728\u8BFB\u53D6 QQ \u673A\u5668\u4EBA\u72B6\u6001\u2026")
  );
}
    ...
    h4(
      ...
      h4(
        ...
        h4(
          ...
          h4("span", null, "\u5C1A\u672A\u7ED1\u5B9A QQ \u673A\u5668\u4EBA")
        ),
        h4("h3", null, "\u4F7F\u7528\u624B\u673A QQ \u626B\u7801\u521B\u5EFA\u5E76\u7ED1\u5B9A\u673A\u5668\u4EBA"),
        h4("p", null, "\u626B\u7801\u7531\u817E\u8BAF\u5B98\u65B9\u9875\u9762\u5B8C\u6210\uFF0C\u4E0D\u9700\u8981\u624B\u52A8\u586B\u5199 AppID \u6216 AppSecret\u3002\u626B\u7801\u6210\u529F\u540E\uFF0C\u673A\u5668\u4EBA\u4F1A\u81EA\u52A8\u8FDE\u63A5 DeepSeek Harness\u3002"),
        h4(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h4(
    ...
    h4(
      ...
      h4(
        ...
        h4(
          "div",
          { className: "ddt-qrFrame dim-qrFrame" },
          source ? h4("img", { src: source, alt: "\u7528\u4E8E\u7ED1\u5B9A QQ \u673A\u5668\u4EBA\u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801" }) : h4(
            "div",
        ...
        h4(
          ...
          h4(
            "div",
            { className: "ddt-countdownTop dim-countdownTop" },
            h4("span", null, "\u5F53\u524D\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"),
            h4("strong", null, refreshing ? "--:--" : formatRemaining3(remaining))
          ),
          h4("div", { className: "ddt-progress dim-progress", style: { "--ddt-progress": `${progress}%` } }, h4("span"))
        )
      ),
      h4(
        "div",
        ...
        h4(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h4("span", { className: "ddt-dot dim-stateDot", "data-tone": "warning" }),
          h4("span", null, refreshing ? "\u6B63\u5728\u5237\u65B0\u4E8C\u7EF4\u7801" : "\u7B49\u5F85\u624B\u673A QQ \u626B\u7801")
        ),
        h4("h3", null, "\u4F7F\u7528\u624B\u673A QQ \u5B8C\u6210\u673A\u5668\u4EBA\u7ED1\u5B9A"),
        h4("p", null, "\u817E\u8BAF\u9875\u9762\u4F1A\u521B\u5EFA\u6216\u7ED1\u5B9A\u4E00\u4E2A QQ \u673A\u5668\u4EBA\uFF0C\u5E76\u628A\u8FDE\u63A5\u51ED\u636E\u5B89\u5168\u4EA4\u7ED9\u672C\u673A Harness Host\u3002"),
        h4(
          "ol",
          { className: "ddt-steps dim-steps" },
          h4("li", null, "\u6253\u5F00\u624B\u673A QQ\uFF0C\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h4("li", null, "\u5728\u817E\u8BAF\u6388\u6743\u9875\u9762\u786E\u8BA4\u521B\u5EFA\u6216\u7ED1\u5B9A\u673A\u5668\u4EBA"),
          h4("li", null, "\u8FD4\u56DE\u8FD9\u91CC\u7B49\u5F85\u8FDE\u63A5\u5B8C\u6210")
        ),
        h4(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h4(Button5, { onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
          h4(Button5, { kind: "quiet", onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function ProvisionView({ provision, busy, onRetry, onClose }) {
  if (provision.status === "connecting") {
    return h4(
      ...
      h4("div", { className: "ddt-spinner dim-spinner" }),
      h4("h3", null, "QQ \u5DF2\u6388\u6743\uFF0C\u6B63\u5728\u8FDE\u63A5\u673A\u5668\u4EBA"),
      h4("p", null, "\u51ED\u636E\u6B63\u5728\u5199\u5165\u672C\u673A\uFF0C\u5E76\u542F\u52A8 QQ WebSocket \u6D88\u606F\u8FDE\u63A5\u3002")
    );
  }
  ...
  return h4(
    ...
    h4(
      "div",
      { className: "ddt-inlineError dim-inlineError", role: "alert" },
      h4("h3", null, "QQ \u673A\u5668\u4EBA\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h4("p", null, error.message),
      h4("span", { className: "ddt-errorCode" }, error.code),
      h4(
        "div",
        { className: "ddt-actions dim-viewActions" },
...
function RemoveConfirmation3({ account, busy, onConfirm, onCancel }) {
  return h4(
    ...
    h4("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684\u5E94\u7528\u51ED\u636E\u3001\u673A\u5668\u4EBA\u914D\u7F6E\u53CA\u4F1A\u8BDD\u6620\u5C04\u3002\u817E\u8BAF\u5E73\u53F0\u4E2D\u7684\u673A\u5668\u4EBA\u4E0D\u4F1A\u88AB\u81EA\u52A8\u5220\u9664\u3002"),
    h4(
      "div",
      { className: "ddt-actions dim-viewActions" },
      h4(Button5, { onClick: onCancel, disabled: busy }, "\u4FDD\u7559\u673A\u5668\u4EBA"),
      h4(Button5, { kind: "danger", onClick: onConfirm, disabled: busy }, busy ? "\u6B63\u5728\u79FB\u9664\u2026" : "\u786E\u8BA4\u79FB\u9664\u63A5\u5165")
    )
  );
}
    ...
    h4(
      ...
      h4(
        ...
        h4(
          "div",
          { className: "ddt-accountIdentity dim-botIdentity" },
          h4("div", { className: "ddt-avatar dim-botAvatar dqq-avatar", "aria-hidden": "true" }, h4(QqLogoGlyph, { size: 29 })),
          h4(
            "div",
            { className: "dim-botName" },
            h4("h3", null, account.bot.name),
            h4("p", null, account.bot.appIdMasked)
          )
        ),
        h4(
          "div",
      ...
      h4(
        "dl",
        { className: "ddt-metrics dim-botMetrics" },
        h4("div", { className: "ddt-metric dim-botMetric" }, h4("dt", null, "\u6D88\u606F\u901A\u9053"), h4("dd", null, account.connected ? "WebSocket \u957F\u8FDE\u63A5" : "\u79BB\u7EBF")),
        h4("div", { className: "ddt-metric dim-botMetric" }, h4("dt", null, "\u6700\u8FD1\u68C0\u67E5"), h4("dd", null, checkedTime2(account.health.lastCheckedAt)))
      ),
      h4(
        "div",
        { className: "ddt-accountFooter dim-cardFooter" },
        h4("div", { className: "ddt-summary dim-cardSummary" }, account.error?.message ?? account.health.summary),
        h4(
          "div",
          { className: "ddt-actions dim-cardActions" },
          h4(Button5, { className: "dim-cardAction", onClick: onReconnect, disabled: Boolean(busy) }, busy === "reconnect" ? "\u68C0\u67E5\u4E2D\u2026" : account.connected ? "\u68C0\u67E5\u8FDE\u63A5" : "\u91CD\u8BD5\u8FDE\u63A5"),
          h4(Button5, { className: "dim-cardAction", kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h4(RemoveConfirmation3, {
      account,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function QqSettingsTab({ rpcCall }) {
  const [model, setModel] = React5.useState({ phase: "loading", bots: [], totals: { configured: 0, connected: 0 }, error: null });
  ...
  const loadStatus = React5.useCallback(async ({ signal, silent = false, restore = false } = {}) => {
  ...
  const closeProvision = React5.useCallback(async () => {
    setBusy(true);
    try {
  ...
  let provisionView = null;
  if (provision?.status === "starting") provisionView = h4("div", { className: "ddt-card ddt-loading dim-surfaceCard" }, h4("div", { className: "ddt-spinner" }), "\u6B63\u5728\u7533\u8BF7 QQ \u4E8C\u7EF4\u7801\u2026");
  else if (["pending", "refreshing"].includes(provision?.status)) provisionView = h4(QrPanel2, {
    provision,
    now,
    busy,
  ...
  else if (provision) provisionView = h4(ProvisionView, {
    provision,
    busy,
  ...
  const botList = model.bots.length > 0 ? h4(
    ...
    h4(
      "div",
      { className: "ddt-listHeading dim-listHeading" },
      h4("h3", null, "\u5DF2\u7ED1\u5B9A\u7684 QQ \u673A\u5668\u4EBA"),
      h4("span", null, `${model.bots.length} \u4E2A`)
    ),
    h4("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h4("li", { key: account.botId }, h4(AccountCard2, {
      account,
  ...
  return h4(
    ...
    h4(Heading3, { totals: model.totals, adding: Boolean(provision), busy, onAdd: () => void startProvisioning(), addButtonRef }),
    model.phase === "loading" ? h4(LoadingView3) : model.phase === "error" ? h4("div", { className: "ddt-card dim-surfaceCard" }, h4("div", { className: "ddt-inlineError dim-inlineError" }, h4("h3", null, "\u65E0\u6CD5\u8BFB\u53D6 QQ \u673A\u5668\u4EBA\u72B6\u6001"), h4("p", null, model.error?.message), h4(Button5, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6"))) : h4(
      React5.Fragment,
      null,
      provisionView,
      model.bots.length === 0 && !provision ? h4(EmptyView3, { busy, onStart: () => void startProvisioning() }) : null,
      botList
    )
  );
}
...
var Button7 = React6.forwardRef(function Button8({ children, kind = "secondary", className = "", ...props }, ref) {
  return h5("button", {
    ...props,
    ref,
    type: "button",
...
function Heading4({ totals, adding, busy, onAdd, addButtonRef }) {
  return h5(
    "div",
    { className: "ddt-heading" },
    h5(
    ...
    h5(
      ...
      h5(
        ...
        h5(
          ...
          h5("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA")
        ),
        h5("h3", null, "\u4F7F\u7528\u4F01\u4E1A\u5FAE\u4FE1 App \u626B\u7801\u521B\u5EFA\u667A\u80FD\u673A\u5668\u4EBA"),
        h5("p", null, "\u626B\u7801\u7531\u817E\u8BAF\u5B98\u65B9\u9875\u9762\u5B8C\u6210\uFF0C\u4E0D\u9700\u8981\u624B\u52A8\u586B\u5199 Bot ID \u6216 Secret\u3002\u521B\u5EFA\u6210\u529F\u540E\uFF0C\u673A\u5668\u4EBA\u4F1A\u81EA\u52A8\u8FDE\u63A5 DeepSeek Harness\u3002"),
        h5(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h5(
    ...
    h5(
      ...
      h5(
        ...
        h5(
          "div",
          { className: "ddt-qrFrame dim-qrFrame" },
          source ? h5("img", { src: source, alt: "\u7528\u4E8E\u7ED1\u5B9A\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801" }) : h5(
            "div",
            { className: "ddt-qrFallback dim-qrFallback" },
            refreshing ? "\u4E8C\u7EF4\u7801\u6B63\u5728\u81EA\u52A8\u5237\u65B0\u2026" : "\u4E8C\u7EF4\u7801\u56FE\u7247\u6B63\u5728\u751F\u6210\u2026"
          )
        ...
        h5(
          ...
          h5(
            ...
            h5("strong", null, refreshing ? "--:--" : formatRemaining4(remaining))
          ),
      ...
      h5(
        ...
        h5(
          ...
          h5("span", null, refreshing ? "\u6B63\u5728\u5237\u65B0\u4E8C\u7EF4\u7801" : "\u7B49\u5F85\u4F01\u4E1A\u5FAE\u4FE1 App \u626B\u7801")
        ),
        h5("h3", null, "\u4F7F\u7528\u4F01\u4E1A\u5FAE\u4FE1 App \u5B8C\u6210\u667A\u80FD\u673A\u5668\u4EBA\u6388\u6743"),
        h5("p", null, "\u4F01\u4E1A\u5FAE\u4FE1\u5B98\u65B9\u9875\u9762\u4F1A\u521B\u5EFA\u4E00\u4E2A\u667A\u80FD\u673A\u5668\u4EBA\uFF0C\u5E76\u628A\u8FDE\u63A5\u51ED\u636E\u5B89\u5168\u4EA4\u7ED9\u672C\u673A Harness Host\u3002"),
        h5(
          "ol",
          { className: "ddt-steps dim-steps" },
          h5("li", null, "\u6253\u5F00\u4F01\u4E1A\u5FAE\u4FE1 App\uFF0C\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h5("li", null, "\u5728\u817E\u8BAF\u6388\u6743\u9875\u9762\u786E\u8BA4\u521B\u5EFA\u667A\u80FD\u673A\u5668\u4EBA"),
          h5("li", null, "\u8FD4\u56DE\u8FD9\u91CC\u7B49\u5F85\u8FDE\u63A5\u5B8C\u6210")
        ),
        h5(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h5(Button7, { onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
          h5(Button7, { kind: "quiet", onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function ProvisionView2({ provision, busy, onRetry, onClose }) {
  if (provision.status === "connecting") {
    return h5(
      ...
      { className: "ddt-card ddt-loading dim-surfaceCard dim-specialView", "aria-busy": "true" },
      h5("div", { className: "ddt-spinner dim-spinner" }),
      h5("h3", null, "\u4F01\u4E1A\u5FAE\u4FE1\u5DF2\u6388\u6743\uFF0C\u6B63\u5728\u8FDE\u63A5\u673A\u5668\u4EBA"),
      h5("p", null, "\u51ED\u636E\u6B63\u5728\u5199\u5165\u672C\u673A\uFF0C\u5E76\u542F\u52A8\u4F01\u4E1A\u5FAE\u4FE1 WebSocket \u6D88\u606F\u8FDE\u63A5\u3002")
    );
  }
  ...
  return h5(
    ...
    h5(
      "div",
      { className: "ddt-inlineError dim-inlineError", role: "alert" },
      h5("h3", null, "\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h5("p", null, error.message),
      h5("span", { className: "ddt-errorCode" }, error.code),
      h5(
        "div",
        { className: "ddt-actions dim-viewActions" },
        h5(Button7, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h5(Button7, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
function RemoveConfirmation4({ account, busy, onConfirm, onCancel }) {
  return h5(
    ...
    h5("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684\u5E94\u7528\u51ED\u636E\u3001\u673A\u5668\u4EBA\u914D\u7F6E\u53CA\u4F1A\u8BDD\u6620\u5C04\u3002\u4F01\u4E1A\u5FAE\u4FE1\u5E73\u53F0\u4E2D\u7684\u673A\u5668\u4EBA\u4E0D\u4F1A\u88AB\u81EA\u52A8\u5220\u9664\u3002"),
    h5(
      "div",
      { className: "ddt-actions dim-viewActions" },
      h5(Button7, { onClick: onCancel, disabled: busy }, "\u4FDD\u7559\u673A\u5668\u4EBA"),
      h5(Button7, { kind: "danger", onClick: onConfirm, disabled: busy }, busy ? "\u6B63\u5728\u79FB\u9664\u2026" : "\u786E\u8BA4\u79FB\u9664\u63A5\u5165")
    )
  );
}
    ...
    h5(
      ...
      h5(
        ...
        h5(
          "div",
          { className: "ddt-accountIdentity dim-botIdentity" },
          h5("div", { className: "ddt-avatar dim-botAvatar dwecom-avatar", "aria-hidden": "true" }, h5(WecomLogoGlyph, { size: 29 })),
          h5(
            "div",
            { className: "dim-botName" },
      ...
      h5(
        ...
        h5("div", { className: "ddt-metric dim-botMetric" }, h5("dt", null, "\u6700\u8FD1\u68C0\u67E5"), h5("dd", null, checkedTime3(account.health.lastCheckedAt)))
      ),
      h5(
        "div",
        { className: "ddt-accountFooter dim-cardFooter" },
        h5("div", { className: "ddt-summary dim-cardSummary" }, account.error?.message ?? account.health.summary),
        h5(
          "div",
          { className: "ddt-actions dim-cardActions" },
          h5(Button7, { className: "dim-cardAction", onClick: onReconnect, disabled: Boolean(busy) }, busy === "reconnect" ? "\u68C0\u67E5\u4E2D\u2026" : account.connected ? "\u68C0\u67E5\u8FDE\u63A5" : "\u91CD\u8BD5\u8FDE\u63A5"),
          h5(Button7, { className: "dim-cardAction", kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h5(RemoveConfirmation4, {
      account,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function WecomSettingsTab({ rpcCall }) {
  ...
  let provisionView = null;
  if (provision?.status === "starting") provisionView = h5("div", { className: "ddt-card ddt-loading dim-surfaceCard" }, h5("div", { className: "ddt-spinner" }), "\u6B63\u5728\u7533\u8BF7\u4F01\u4E1A\u5FAE\u4FE1\u4E8C\u7EF4\u7801\u2026");
  else if (["pending", "refreshing"].includes(provision?.status)) provisionView = h5(QrPanel3, {
    provision,
    now,
    busy,
    onRefresh: () => void startProvisioning(true),
  ...
  else if (provision) provisionView = h5(ProvisionView2, {
    provision,
    busy,
    onRetry: () => void startProvisioning(true),
    onClose: () => void closeProvision()
  ...
  const botList = model.bots.length > 0 ? h5(
    ...
    h5(
      "div",
      { className: "ddt-listHeading dim-listHeading" },
      h5("h3", null, "\u5DF2\u7ED1\u5B9A\u7684\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA"),
      h5("span", null, `${model.bots.length} \u4E2A`)
    ),
    h5("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h5("li", { key: account.botId }, h5(AccountCard3, {
      account,
      busy: busyByBot[account.botId],
      removing: removeTarget === account.botId,
  ...
  return h5(
    ...
    h5(Heading4, { totals: model.totals, adding: Boolean(provision), busy, onAdd: () => void startProvisioning(), addButtonRef }),
    model.phase === "loading" ? h5(LoadingView4) : model.phase === "error" ? h5("div", { className: "ddt-card dim-surfaceCard" }, h5("div", { className: "ddt-inlineError dim-inlineError" }, h5("h3", null, "\u65E0\u6CD5\u8BFB\u53D6\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u72B6\u6001"), h5("p", null, model.error?.message), h5(Button7, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6"))) : h5(
      React6.Fragment,
      null,
      provisionView,
      model.bots.length === 0 && !provision ? h5(EmptyView4, { busy, onStart: () => void startProvisioning() }) : null,
      botList
    )
  );
}
...
var Button9 = React7.forwardRef(function Button10({ children, kind = "secondary", className = "", ...props }, ref) {
  return h6("button", {
    ...props,
    ref,
    type: "button",
...
function LoadingView5() {
  return h6(
    ...
    h6("div", { className: "dxw-spinner dim-spinner" }),
    h6("span", null, "\u6B63\u5728\u8BFB\u53D6\u5FAE\u4FE1\u8FDE\u63A5\u72B6\u6001\u2026")
  );
}
    ...
    h6(
      ...
      h6(
        ...
        h6(
          ...
          h6("span", { className: "dxw-dot dim-stateDot" }),
          h6("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u5FAE\u4FE1")
        ),
        h6("h3", null, "\u626B\u4E00\u6B21\u7801\uFF0C\u5C31\u80FD\u5728\u5FAE\u4FE1\u91CC\u4F7F\u7528 Harness"),
        h6("p", null, "\u4E8C\u7EF4\u7801\u7531\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u7B7E\u53D1\u3002\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u5E76\u786E\u8BA4\u540E\uFF0C\u8D26\u53F7\u51ED\u636E\u4F1A\u76F4\u63A5\u5199\u5165 Harness Host\uFF0C\u6D4F\u89C8\u5668\u4E0D\u4F1A\u6536\u5230 bot_token\u3002"),
        h6(
          "div",
      ...
      h6("div", { className: "dxw-logo dim-emptyBrand", "aria-hidden": "true" }, h6(WeixinLogoGlyph, { size: 64 }))
    )
  );
}
    ...
    h6(
      ...
      h6(
        ...
        h6(
          ...
          source && !imageFailed ? h6("img", {
            src: source,
            alt: "\u7528\u4E8E\u628A\u5FAE\u4FE1\u673A\u5668\u4EBA\u7ED1\u5B9A\u5230 DeepSeek Harness \u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801",
            onError: () => setImageFailed(true)
          }) : h6("div", { className: "dxw-qrFallback dim-qrFallback" }, "\u4E8C\u7EF4\u7801\u56FE\u7247\u672A\u5C31\u7EEA\uFF0C\u8BF7\u4F7F\u7528\u5907\u7528\u94FE\u63A5\u3002"),
          expired ? h6("div", { className: "dxw-expired dim-qrExpired" }, "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F\n\u8BF7\u91CD\u65B0\u751F\u6210") : null
        ),
        h6(
          "div",
          { className: "dxw-countdown dim-countdown" },
          h6("div", { className: "dim-countdownTop" }, h6("span", null, "\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"), h6("strong", null, formatRemaining5(remaining))),
          h6(
            "div",
            { className: "dxw-progress dim-progress", "aria-hidden": "true" },
            h6("span", { style: { "--dxw-progress": `${progress}%` } })
          )
        )
      ),
      h6(
        ...
        h6(
          "div",
          { className: "dxw-stateLabel dim-stateLabel" },
          h6("span", { className: "dxw-dot dim-stateDot", "data-tone": provision.status === "scanned" ? "success" : "warning" }),
          h6("span", null, provision.status === "scanned" ? "\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4" : "\u7B49\u5F85\u5FAE\u4FE1\u626B\u7801")
        ),
        h6("h3", null, expired ? "\u4E8C\u7EF4\u7801\u5DF2\u5931\u6548" : "\u4F7F\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u4E8C\u7EF4\u7801"),
        h6("p", null, "\u8BF7\u5728\u624B\u673A\u4E0A\u6838\u5BF9\u5E76\u786E\u8BA4\u6388\u6743\u3002\u90E8\u5206\u8D26\u53F7\u4F1A\u989D\u5916\u663E\u793A\u4E00\u4E2A\u914D\u5BF9\u6570\u5B57\uFF0C\u9875\u9762\u4F1A\u5728\u9700\u8981\u65F6\u63D0\u793A\u8F93\u5165\u3002"),
        h6(
          "ol",
          { className: "dxw-steps dim-steps" },
          h6("li", null, "\u6253\u5F00\u624B\u673A\u5FAE\u4FE1\u5E76\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h6("li", null, "\u5728\u5FAE\u4FE1\u4E2D\u786E\u8BA4\u8FDE\u63A5\u8BE5\u673A\u5668\u4EBA"),
          h6("li", null, "\u4FDD\u6301\u672C\u9875\u6253\u5F00\uFF0C\u7B49\u5F85\u6D88\u606F\u957F\u8F6E\u8BE2\u53D8\u4E3A\u5728\u7EBF")
        ),
        h6(
          "div",
          { className: "dxw-actions dim-viewActions" },
          expired ? h6(Button9, { kind: "primary", onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801") : null,
          href ? h6("a", {
          ...
          !expired ? h6(Button9, { onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
          h6(Button9, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function VerificationPanel({ provision, busy, onSubmit, onCancel }) {
  ...
  React7.useEffect(() => setCode(""), [provision.attemptId]);
  return h6(
    "div",
    { className: "dxw-card dim-surfaceCard" },
    h6(
      ...
      h6(
        ...
        h6("span", { className: "dxw-dot", "data-tone": "warning" }),
        h6("span", null, "\u9700\u8981\u914D\u5BF9\u7801")
      ),
      h6("h3", null, "\u8F93\u5165\u624B\u673A\u5FAE\u4FE1\u663E\u793A\u7684\u6570\u5B57"),
      h6("p", null, "\u8FD9\u662F\u5FAE\u4FE1\u9644\u52A0\u7684\u5B89\u5168\u786E\u8BA4\u6B65\u9AA4\u3002\u914D\u5BF9\u7801\u53EA\u7528\u4E8E\u672C\u6B21\u626B\u7801\u8F6E\u8BE2\uFF0C\u4E0D\u4F1A\u5199\u5165\u914D\u7F6E\u6216\u65E5\u5FD7\u3002"),
      h6(
        "div",
      ...
      h6(Button9, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88\u7ED1\u5B9A")
    )
  );
}
function ProgressPanel2({ scanned, onCancel, busy }) {
  return h6(
    ...
    { className: "dxw-card dxw-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" },
    h6("div", { className: "dxw-spinner dim-spinner" }),
    h6("h3", null, scanned ? "\u5FAE\u4FE1\u5DF2\u786E\u8BA4\uFF0C\u6B63\u5728\u542F\u52A8\u6D88\u606F\u8FDE\u63A5" : "\u6B63\u5728\u51C6\u5907\u5FAE\u4FE1\u4E8C\u7EF4\u7801"),
    h6("p", null, scanned ? "\u6B63\u5728\u4FDD\u5B58\u51ED\u636E\u5E76\u9A8C\u8BC1 Harness \u4E0E\u5FAE\u4FE1\u957F\u8F6E\u8BE2\u3002" : "\u6B63\u5728\u8054\u7CFB\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u3002"),
    onCancel ? h6(
      "div",
...
function ProvisionError3({ provision, busy, onRetry, onClose }) {
  ...
  return h6(
    ...
    h6(
      ...
      h6("h3", null, provision.status === "expired" ? "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F" : "\u5FAE\u4FE1\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h6("p", null, error.message),
      h6("span", { className: "dxw-errorCode" }, error.code),
      h6(
        "div",
        { className: "dxw-actions dim-viewActions" },
        h6(Button9, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h6(Button9, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
    ...
    h6(
      ...
      h6(
        ...
        h6(
          ...
          h6("div", { className: "dxw-avatar dim-botAvatar", "aria-hidden": "true" }, h6(WeixinLogoGlyph, { size: 27 })),
          h6("div", { className: "dim-botName" }, h6("h3", null, account.bot.name), h6("p", null, account.bot.accountIdMasked))
        ),
        h6(
          "div",
          { className: "dxw-health dim-botHealth" },
          h6("span", { className: "dxw-dot dim-healthDot", "data-tone": tone }),
          h6("span", null, account.connected ? "\u8FD0\u884C\u6B63\u5E38" : state === "connecting" ? "\u6B63\u5728\u8FDE\u63A5" : "\u8FDE\u63A5\u672A\u5C31\u7EEA")
        )
      ),
      h6(
        "dl",
        ...
        h6(
          ...
          h6("dt", null, "\u6D88\u606F\u901A\u9053"),
          h6("dd", null, account.connected ? "iLink \u957F\u8F6E\u8BE2" : "\u79BB\u7EBF")
        ),
        h6(
          "div",
          { className: "dxw-metric dim-botMetric" },
          h6("dt", null, "\u6700\u8FD1\u68C0\u67E5"),
          h6("dd", null, checkedTime4(account.health.lastCheckedAt))
        )
      ),
      h6(
        "div",
        { className: "dxw-accountFooter dim-cardFooter" },
        h6("div", { className: "dxw-summary dim-cardSummary" }, account.error?.message ?? account.health.summary),
        h6(
          "div",
          ...
          h6(Button9, { className: "dim-cardAction", kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h6(
      ...
      h6("strong", null, "\u4ECE\u6B64 Harness \u79FB\u9664\u8FD9\u4E2A\u5FAE\u4FE1\u8D26\u53F7\uFF1F"),
      h6("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684 bot_token\u3001\u8D26\u53F7\u914D\u7F6E\u548C\u4F1A\u8BDD\u6620\u5C04\u3002\u5176\u4ED6\u5FAE\u4FE1\u8D26\u53F7\u4E0D\u53D7\u5F71\u54CD\u3002"),
      h6(
        "div",
        { className: "dxw-actions dim-viewActions" },
        h6(Button9, { onClick: onCancelRemove, disabled: busy === "delete" }, "\u4FDD\u7559\u8D26\u53F7"),
        h6(
          Button9,
...
function AccountList2(props) {
  return h6(
    "section",
    { className: "dim-listSection" },
    h6("div", { className: "dxw-listHeading dim-listHeading" }, h6("h3", null, "\u5DF2\u63A5\u5165\u7684\u5FAE\u4FE1\u8D26\u53F7"), h6("span", null, `${props.bots.length} \u4E2A`)),
    h6("ul", { className: "dxw-list dim-botList" }, props.bots.map((account) => h6(
      "li",
      { key: account.botId },
      h6(AccountCard4, {
        account,
...
function WeixinSettingsTab({ rpcCall }) {
  ...
  const scheduleAnimationFrame = useAnimationFrameScheduler();
  const announce = React7.useCallback((value) => {
    setNotice("");
    scheduleAnimationFrame(() => {
  ...
  const submitVerification = React7.useCallback(async (verifyCode) => {
  ...
  const reconnect = React7.useCallback(async (account) => {
  ...
  let provisionView = null;
  if (provision?.status === "starting") {
    provisionView = h6(ProgressPanel2, { busy });
  } else if (["pending", "scanned"].includes(provision?.status)) {
    provisionView = h6(QrPanel4, {
      provision,
      now,
      busy,
      onRefresh: () => void startProvisioning({ replace: true }),
    ...
    provisionView = h6(VerificationPanel, {
      provision,
      busy,
    ...
    provisionView = h6(ProgressPanel2, {
      scanned: true,
      busy,
      onCancel: () => void cancelProvisioning()
    });
  } else if (provision && ["failed", "expired", "cancelled"].includes(provision.status)) {
    provisionView = h6(ProvisionError3, {
      provision,
      busy,
      onRetry: () => void startProvisioning({ replace: Boolean(provision.attemptId) }),
      onClose: () => void cancelProvisioning()
  ...
  return h6(
    ...
    h6("div", { className: "dxw-visuallyHidden", role: "status", "aria-live": "polite" }, notice),
    model.error && model.phase === "ready" ? h6("div", { className: "dxw-statusNotice dim-statusNotice" }, `\u72B6\u6001\u5237\u65B0\u5931\u8D25\uFF1A${model.error.message}`) : null,
    model.phase === "loading" ? h6(LoadingView5) : model.phase === "error" ? h6(
      "div",
      { className: "dxw-card dim-surfaceCard" },
      h6(
        "div",
        ...
        h6("h3", null, "\u65E0\u6CD5\u8BFB\u53D6\u5FAE\u4FE1\u72B6\u6001"),
        h6("p", null, model.error?.message ?? "\u8BF7\u7A0D\u540E\u91CD\u8BD5"),
        h6(Button9, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6")
      )
    ) : h6(
      React7.Fragment,
      null,
      provisionView,
      model.bots.length === 0 && !provision ? h6(EmptyView5, { onStart: () => void startProvisioning(), busy }) : null,
      model.bots.length > 0 ? h6(AccountList2, {
        bots: model.bots,
        busyByBot,
        removeTarget,
        onReconnect: (account) => void reconnect(account),
...
function DingtalkLogo() {
  return h7(
    ...
    h7(DingtalkLogoGlyph)
  );
}
function QqLogo() {
  return h7("span", { className: "dim-logo dim-logoQq", "aria-hidden": "true" }, h7(QqLogoGlyph));
}
function WecomLogo() {
  return h7("span", { className: "dim-logo dim-logoWecom", "aria-hidden": "true" }, h7(WecomLogoGlyph));
}
function ChannelLogo({ channel }) {
  if (channel === "weixin") return h7(WeixinLogo);
  if (channel === "feishu") return h7(FeishuLogo);
  if (channel === "dingtalk") return h7(DingtalkLogo);
  if (channel === "wecom") return h7(WecomLogo);
  return h7(QqLogo);
}
function IMSettingsTab({ dingtalkRpcCall, feishuRpcCall, qqRpcCall, wecomRpcCall, weixinRpcCall }) {
  const [selected, setSelected] = React8.useState("weixin");
  ...
  return h7(
    ...
    h7(
      "header",
      { className: "dim-title" },
      h7("p", null, "\u901A\u8FC7\u626B\u7801\u628A\u673A\u5668\u4EBA\u63A5\u5165 DeepSeek Harness")
    ),
    h7(
      "div",
      ...
      h7(
        ...
        CHANNELS.map((channel) => h7(
          ...
          h7(ChannelLogo, { channel: channel.id }),
          h7(
            "span",
            { className: "dim-channelCopy" },
            h7("strong", null, channel.label)
          )
        ))
      ),
      h7("div", { className: "dim-divider", "aria-hidden": "true" }),
      h7("main", {
        className: "dim-panel",
        role: "tabpanel",
        id: `dim-panel-${active.id}`,
        "aria-labelledby": `dim-tab-${active.id}`
      }, active.id === "weixin" ? h7(WeixinSettingsTab, { rpcCall: weixinRpcCall }) : active.id === "feishu" ? h7(FeishuSettingsTab, { rpcCall: feishuRpcCall }) : active.id === "dingtalk" ? h7(DingtalkSettingsTab, { rpcCall: dingtalkRpcCall }) : active.id === "wecom" ? h7(WecomSettingsTab, { rpcCall: wecomRpcCall }) : h7(QqSettingsTab, { rpcCall: qqRpcCall }))
    )
  );
}
function apply(ctx) {
