...
// node_modules/@xmanrui/dsh-dingtalk/plugin-src/client/api.js
...
// node_modules/@xmanrui/dsh-dingtalk/plugin-src/client/index.js
var React = __toESM(require("react"), 1);

// node_modules/@xmanrui/dsh-dingtalk/plugin-src/client/styles.js
...
var Button3 = React2.forwardRef(function Button4({ children, kind = "secondary", size, icon, className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function BrandMark({ compact = false }) {
  return h2(
    ...
    h2(RobotIcon, { size: compact ? 25 : 34 })
  );
}
function Heading2({ totals, onAdd, adding, busy, addButtonRef }) {
  ...
  return h2(
    ...
    h2(
      ...
      }, h2("strong", null, totals.connected), h2("span", null, `/ ${totals.configured} \u5728\u7EBF`)) : null,
      h2("div", {
        className: "bxf-localBadge",
        title: "\u6BCF\u4E2A\u5E94\u7528\u7684\u51ED\u636E\u5747\u7531 Host \u72EC\u7ACB\u4FDD\u5B58\uFF0C\u4E0D\u4F1A\u53D1\u9001\u5230\u6D4F\u89C8\u5668"
      }, h2(ShieldIcon, { size: 14 }), h2("span", null, "\u51ED\u636E\u4EC5\u4FDD\u5B58\u5728\u672C\u673A")),
      h2(Button3, {
        kind: "primary",
        size: "small",
        icon: h2(PlusIcon),
...
function LoadingView2() {
  return h2("div", {
    ...
    h2("div", { className: "bxf-skeletonLine" }),
    h2("div", { className: "bxf-skeletonLine" }),
    h2("div", { className: "bxf-skeletonBox" })
  ));
}
    ...
    h2(
      ...
      h2(
        ...
        h2(
          "div",
          { className: "bxf-note" },
          h2(ShieldIcon, { size: 16 }),
          h2("span", null, "\u6BCF\u4E2A App Secret \u90FD\u53EA\u5199\u5165 Host \u51ED\u636E\u5B58\u50A8\uFF0C\u6D4F\u89C8\u5668\u4E0D\u4F1A\u6536\u5230 Secret\u3002")
        )
      ),
      h2("div", { className: "bxf-markStage", "aria-hidden": "true" }, h2(BrandMark))
    )
  );
}
...
function QrPane({ provision, now, onRefresh, onCancel, busy }) {
  ...
  React2.useEffect(() => setImageFailed(false), [qrSource]);
  return h2(
    "div",
    ...
    h2(
      ...
      h2(
        ...
        h2(
          "div",
          { className: "bxf-stateLabel" },
          h2("span", { className: "bxf-dot", "data-tone": "warning" }),
        ...
        h2(
          ...
          }, h2(ExternalIcon), h2("span", null, "\u5728\u98DE\u4E66\u4E2D\u6253\u5F00")) : null,
          !expired ? h2(Button3, { icon: h2(RefreshIcon), onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
      ...
      h2(
        ...
        h2(
          ...
          h2(
            ...
            connecting ? h2(RobotIcon, { size: 24 }) : h2(SparkIcon, { size: 24 })
          )
        ),
...
function ProvisionError2({ error, onRetry, onCancel, busy }) {
  return h2(
    ...
    h2(
      ...
      h2("div", { className: "bxf-errorIcon" }, h2(AlertIcon)),
      h2(
        "div",
        null,
        ...
        h2(
          ...
          h2(
            Button3,
            { kind: "primary", icon: h2(RefreshIcon), onClick: onRetry, disabled: busy },
            busy ? "\u91CD\u8BD5\u4E2D\u2026" : "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"
          ),
    ...
    h2(
      ...
      h2(
        ...
        h2(
          ...
          bot.avatarUrl ? h2("div", { className: "bxf-avatar" }, h2("img", { src: bot.avatarUrl, alt: "" })) : h2(BrandMark, { compact: true }),
          h2(
            "div",
            { className: "bxf-botName" },
            h2("h3", { id: titleId, title: bot.name }, bot.name),
            h2("p", null, bot.tenantName ? `${bot.tenantName} \xB7 ${domainLabel}\u673A\u5668\u4EBA` : `${domainLabel}\u673A\u5668\u4EBA`)
          )
        ),
        h2(
          "div",
      ...
      h2(
        ...
        h2(
          ...
          { className: "bxf-metric" },
          h2("dt", null, "\u5E94\u7528\u6807\u8BC6"),
          h2("dd", { title: bot.appIdMasked }, bot.appIdMasked ?? "\u5DF2\u5B89\u5168\u4FDD\u5B58")
        ),
        h2(
          "div",
          { className: "bxf-metric" },
...
function FeishuSettingsTab({ rpcCall }) {
  ...
  const [pageBusy, setPageBusy] = React2.useState(false);
  const [provisionBusy, setProvisionBusy] = React2.useState(false);
  const [busyByBot, setBusyByBot] = React2.useState({});
  const [errorsByBot, setErrorsByBot] = React2.useState({});
  const [removeTargetId, setRemoveTargetId] = React2.useState(null);
  const [announcement, setAnnouncement] = React2.useState("");
  const [now, setNow] = React2.useState(() => Date.now());
  const [focusBotId, setFocusBotId] = React2.useState(null);
  const cardRefs = React2.useRef(/* @__PURE__ */ new Map());
  const removeButtonRefs = React2.useRef(/* @__PURE__ */ new Map());
  ...
  const mergeSnapshot = React2.useCallback((snapshot, { restoreProvisioning = true } = {}) => {
    setModel((current) => {
  ...
  const loadStatus = React2.useCallback(async ({ signal, silent = false, restoreProvisioning = true } = {}) => {
  ...
  React2.useEffect(() => {
    ...
    const tick = () => {
      const timestamp3 = Date.now();
      setNow(timestamp3);
      if (timestamp3 >= provision2.expiresAt) {
  ...
  const setBotError = React2.useCallback((botId, error) => {
  ...
  const reconnectOneBot = React2.useCallback(async (connection) => {
  ...
  const requestRemove = React2.useCallback((connection) => {
    setRemoveTargetId(connection.botId);
  }, []);
  const cancelRemove = React2.useCallback(() => {
    const botId = removeTargetId;
    setRemoveTargetId(null);
    window.requestAnimationFrame(() => removeButtonRefs.current.get(botId)?.focus());
  }, [removeTargetId]);
  const confirmRemove = React2.useCallback(async (connection) => {
    const { botId, bot } = connection;
  ...
  const setCardRef = React2.useCallback((botId, node) => {
    if (node) cardRefs.current.set(botId, node);
    else cardRefs.current.delete(botId);
  }, []);
  const setRemoveButtonRef = React2.useCallback((botId, node) => {
  ...
  return h2(
    ...
    model.phase === "loading" ? h2(LoadingView2) : model.phase === "error" ? h2(PageError, {
      ...
      null,
      provisionContent,
      model.bots.length === 0 && !provision ? h2(EmptyView2, { onStart: () => void startProvisioning(), busy: provisionBusy }) : null,
...
function WeixinIcon({ size = 26 }) {
  return h3(
    ...
    h3("circle", { cx: "7.25", cy: "9.5", r: "1", fill: "white" }),
    h3("circle", { cx: "11.55", cy: "9.5", r: "1", fill: "white" }),
    h3("circle", { cx: "12.1", cy: "13.2", r: ".9", fill: "white" }),
    h3("circle", { cx: "16.3", cy: "13.2", r: ".9", fill: "white" })
  );
}
var Button5 = React3.forwardRef(function Button6({ children, kind = "secondary", className = "", ...props }, ref) {
  return h3("button", {
    ...props,
    ref,
    type: "button",
...
function LoadingView3() {
  return h3(
    ...
    h3("div", { className: "dxw-spinner" }),
    h3("span", null, "\u6B63\u5728\u8BFB\u53D6\u5FAE\u4FE1\u8FDE\u63A5\u72B6\u6001\u2026")
  );
}
    ...
    h3(
      ...
      h3(
        ...
        h3(
          ...
          h3("span", { className: "dxw-dot" }),
          h3("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u5FAE\u4FE1")
        ),
        h3("h3", null, "\u626B\u4E00\u6B21\u7801\uFF0C\u5C31\u80FD\u5728\u5FAE\u4FE1\u91CC\u4F7F\u7528 Harness"),
        h3("p", null, "\u4E8C\u7EF4\u7801\u7531\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u7B7E\u53D1\u3002\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u5E76\u786E\u8BA4\u540E\uFF0C\u8D26\u53F7\u51ED\u636E\u4F1A\u76F4\u63A5\u5199\u5165 Harness Host\uFF0C\u6D4F\u89C8\u5668\u4E0D\u4F1A\u6536\u5230 bot_token\u3002"),
        h3(
          "div",
      ...
      h3("div", { className: "dxw-logo", "aria-hidden": "true" }, h3(WeixinIcon, { size: 64 }))
    )
  );
}
      ...
      h3(
        ...
        h3(
          ...
          source && !imageFailed ? h3("img", {
            ...
            onError: () => setImageFailed(true)
          }) : h3("div", { className: "dxw-qrFallback" }, "\u4E8C\u7EF4\u7801\u56FE\u7247\u672A\u5C31\u7EEA\uFF0C\u8BF7\u4F7F\u7528\u5907\u7528\u94FE\u63A5\u3002"),
          expired ? h3("div", { className: "dxw-expired" }, "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F\n\u8BF7\u91CD\u65B0\u751F\u6210") : null
        ),
        h3(
          "div",
          { className: "dxw-countdown" },
          h3("div", null, h3("span", null, "\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"), h3("strong", null, formatRemaining3(remaining))),
          h3(
            "div",
            { className: "dxw-progress", "aria-hidden": "true" },
            h3("span", { style: { "--dxw-progress": `${progress}%` } })
          )
        )
      ),
      h3(
        ...
        h3(
          "div",
          { className: "dxw-stateLabel" },
          h3("span", { className: "dxw-dot", "data-tone": provision.status === "scanned" ? "success" : "warning" }),
          h3("span", null, provision.status === "scanned" ? "\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4" : "\u7B49\u5F85\u5FAE\u4FE1\u626B\u7801")
        ),
        h3("h3", null, expired ? "\u4E8C\u7EF4\u7801\u5DF2\u5931\u6548" : "\u4F7F\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u4E8C\u7EF4\u7801"),
        h3("p", null, "\u8BF7\u5728\u624B\u673A\u4E0A\u6838\u5BF9\u5E76\u786E\u8BA4\u6388\u6743\u3002\u90E8\u5206\u8D26\u53F7\u4F1A\u989D\u5916\u663E\u793A\u4E00\u4E2A\u914D\u5BF9\u6570\u5B57\uFF0C\u9875\u9762\u4F1A\u5728\u9700\u8981\u65F6\u63D0\u793A\u8F93\u5165\u3002"),
        h3(
          "ol",
          { className: "dxw-steps" },
          h3("li", null, "\u6253\u5F00\u624B\u673A\u5FAE\u4FE1\u5E76\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h3("li", null, "\u5728\u5FAE\u4FE1\u4E2D\u786E\u8BA4\u8FDE\u63A5\u8BE5\u673A\u5668\u4EBA"),
          h3("li", null, "\u4FDD\u6301\u672C\u9875\u6253\u5F00\uFF0C\u7B49\u5F85\u6D88\u606F\u957F\u8F6E\u8BE2\u53D8\u4E3A\u5728\u7EBF")
        ),
        h3(
          "div",
          { className: "dxw-actions" },
          expired ? h3(Button5, { kind: "primary", onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801") : null,
          href ? h3("a", {
          ...
          !expired ? h3(Button5, { onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
          h3(Button5, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function VerificationPanel({ provision, busy, onSubmit, onCancel }) {
  ...
  React3.useEffect(() => setCode(""), [provision.attemptId]);
  return h3(
    "div",
    { className: "dxw-card" },
    h3(
      ...
      h3(
        "div",
        { className: "dxw-stateLabel" },
        h3("span", { className: "dxw-dot", "data-tone": "warning" }),
        h3("span", null, "\u9700\u8981\u914D\u5BF9\u7801")
      ),
      h3("h3", null, "\u8F93\u5165\u624B\u673A\u5FAE\u4FE1\u663E\u793A\u7684\u6570\u5B57"),
      h3("p", null, "\u8FD9\u662F\u5FAE\u4FE1\u9644\u52A0\u7684\u5B89\u5168\u786E\u8BA4\u6B65\u9AA4\u3002\u914D\u5BF9\u7801\u53EA\u7528\u4E8E\u672C\u6B21\u626B\u7801\u8F6E\u8BE2\uFF0C\u4E0D\u4F1A\u5199\u5165\u914D\u7F6E\u6216\u65E5\u5FD7\u3002"),
      h3(
        "div",
      ...
      h3(Button5, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88\u7ED1\u5B9A")
    )
  );
}
function ProgressPanel2({ scanned, onCancel, busy }) {
  return h3(
    ...
    { className: "dxw-card dxw-loading", "aria-busy": "true" },
    h3("div", { className: "dxw-spinner" }),
    h3("h3", null, scanned ? "\u5FAE\u4FE1\u5DF2\u786E\u8BA4\uFF0C\u6B63\u5728\u542F\u52A8\u6D88\u606F\u8FDE\u63A5" : "\u6B63\u5728\u51C6\u5907\u5FAE\u4FE1\u4E8C\u7EF4\u7801"),
    h3("p", null, scanned ? "\u6B63\u5728\u4FDD\u5B58\u51ED\u636E\u5E76\u9A8C\u8BC1 Harness \u4E0E\u5FAE\u4FE1\u957F\u8F6E\u8BE2\u3002" : "\u6B63\u5728\u8054\u7CFB\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u3002"),
    onCancel ? h3(
      "div",
...
function ProvisionError3({ provision, busy, onRetry, onClose }) {
  ...
  return h3(
    ...
    h3(
      ...
      h3("h3", null, provision.status === "expired" ? "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F" : "\u5FAE\u4FE1\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h3("p", null, error.message),
      h3("span", { className: "dxw-errorCode" }, error.code),
      h3(
        "div",
        { className: "dxw-actions" },
        h3(Button5, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h3(Button5, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
    ...
    h3(
      ...
      h3(
        ...
        h3(
          ...
          h3("div", { className: "dxw-avatar", "aria-hidden": "true" }, h3(WeixinIcon, { size: 27 })),
          h3("div", null, h3("h3", null, account.bot.name), h3("p", null, account.bot.accountIdMasked))
        ),
        h3(
          "div",
          { className: "dxw-health" },
          h3("span", { className: "dxw-dot", "data-tone": tone }),
          h3("span", null, account.connected ? "\u8FD0\u884C\u6B63\u5E38" : state === "connecting" ? "\u6B63\u5728\u8FDE\u63A5" : "\u8FDE\u63A5\u672A\u5C31\u7EEA")
        )
      ),
      h3(
        "dl",
        ...
        h3(
          ...
          h3("dt", null, "\u6D88\u606F\u901A\u9053"),
          h3("dd", null, account.connected ? "iLink \u957F\u8F6E\u8BE2" : "\u79BB\u7EBF")
        ),
        h3(
          "div",
          { className: "dxw-metric" },
          h3("dt", null, "\u6536\u5230 / \u56DE\u590D"),
          h3("dd", null, `${account.stats.messagesReceived} / ${account.stats.messagesReplied}`)
        ),
        h3(
          "div",
          { className: "dxw-metric" },
          h3("dt", null, "\u6700\u8FD1\u68C0\u67E5"),
          h3("dd", null, checkedTime2(account.health.lastCheckedAt))
        )
      ),
      h3(
        "div",
        { className: "dxw-accountFooter" },
        h3("div", { className: "dxw-summary" }, account.error?.message ?? account.health.summary),
        h3(
          "div",
          { className: "dxw-actions" },
          h3(
          ...
          h3(Button5, { kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h3(
      ...
      h3("strong", null, "\u4ECE\u6B64 Harness \u79FB\u9664\u8FD9\u4E2A\u5FAE\u4FE1\u8D26\u53F7\uFF1F"),
      h3("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684 bot_token\u3001\u8D26\u53F7\u914D\u7F6E\u548C\u4F1A\u8BDD\u6620\u5C04\u3002\u5176\u4ED6\u5FAE\u4FE1\u8D26\u53F7\u4E0D\u53D7\u5F71\u54CD\u3002"),
      h3(
        "div",
        { className: "dxw-actions" },
        h3(Button5, { onClick: onCancelRemove, disabled: busy === "delete" }, "\u4FDD\u7559\u8D26\u53F7"),
        h3(
          Button5,
...
function AccountList2(props) {
  return h3(
    "section",
    null,
    h3("div", { className: "dxw-listHeading" }, h3("h3", null, "\u5DF2\u63A5\u5165\u7684\u5FAE\u4FE1\u8D26\u53F7"), h3("span", null, `${props.bots.length} \u4E2A`)),
    h3("ul", { className: "dxw-list" }, props.bots.map((account) => h3(
      "li",
      { key: account.botId },
      h3(AccountCard2, {
        account,
...
function WeixinSettingsTab({ rpcCall }) {
  ...
  const announce = React3.useCallback((value) => {
    setNotice("");
  ...
  const loadStatus = React3.useCallback(async ({ signal, silent = false } = {}) => {
    if (!silent) setModel((current) => ({ ...current, phase: "loading", error: null }));
    try {
  ...
  const submitVerification = React3.useCallback(async (verifyCode) => {
  ...
  const setBotBusy = React3.useCallback((botId, value) => {
    setBusyByBot((current) => {
      const next = { ...current };
      if (value) next[botId] = value;
      else delete next[botId];
  ...
  const reconnect = React3.useCallback(async (account) => {
  ...
  let provisionView = null;
  if (provision?.status === "starting") {
    provisionView = h3(ProgressPanel2, { busy });
  } else if (["pending", "scanned"].includes(provision?.status)) {
    provisionView = h3(QrPanel2, {
      provision,
      now,
      busy,
      onRefresh: () => void startProvisioning({ replace: true }),
    ...
    provisionView = h3(VerificationPanel, {
      provision,
      busy,
    ...
    provisionView = h3(ProgressPanel2, {
      scanned: true,
      busy,
      onCancel: () => void cancelProvisioning()
    });
  } else if (provision && ["failed", "expired", "cancelled"].includes(provision.status)) {
    provisionView = h3(ProvisionError3, {
      provision,
      busy,
      onRetry: () => void startProvisioning({ replace: Boolean(provision.attemptId) }),
      onClose: () => void cancelProvisioning()
  ...
  return h3(
    ...
    h3("div", { className: "dxw-visuallyHidden", role: "status", "aria-live": "polite" }, notice),
    model.error && model.phase === "ready" ? h3("div", { className: "dxw-statusNotice" }, `\u72B6\u6001\u5237\u65B0\u5931\u8D25\uFF1A${model.error.message}`) : null,
    model.phase === "loading" ? h3(LoadingView3) : model.phase === "error" ? h3(
      "div",
      { className: "dxw-card" },
      h3(
        "div",
        ...
        h3(Button5, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6")
      )
    ) : h3(
      React3.Fragment,
      null,
      provisionView,
      model.bots.length === 0 && !provision ? h3(EmptyView3, { onStart: () => void startProvisioning(), busy }) : null,
      model.bots.length > 0 ? h3(AccountList2, {
        bots: model.bots,
        busyByBot,
        removeTarget,
        onReconnect: (account) => void reconnect(account),
...
function FeishuLogo() {
  return h4(
    ...
    h4(
      "svg",
      { viewBox: "0 0 24 24", focusable: "false" },
      h4("path", { fill: "#00D6B9", d: "M7.2 4.5h7.6c1.2 0 2.1.55 2.7 1.58 1.05 1.8 1.55 3.45 1.58 4.95-2.04-.62-4.2-.15-6.22 1.45C11.3 9.7 9.42 7.04 7.2 4.5Z" }),
      h4("path", { fill: "#1456B8", d: "M10.8 13.55c3.3-2.93 5.72-4.24 9.47-2.52-1.2 1.45-2.27 4.18-3.86 5.43-1.67 1.31-3.9.5-5.61-.64v-2.27Z" }),
      h4("path", { fill: "#3370FF", d: "M4.4 8.35c3.47 3.61 7.25 6.1 10.33 5.7 1.06-.14 2.2-.72 3.4-1.72-1.04 2.65-2.6 4.8-5.06 6-2.46 1.2-5.56.52-7.42-.72A2.76 2.76 0 0 1 4.4 15.3V8.35Z" })
    )
  );
}
...
function ChannelLogo({ channel }) {
  if (channel === "weixin") return h4(WeixinLogo);
  if (channel === "feishu") return h4(FeishuLogo);
  return h4(DingtalkLogo);
}
function IMSettingsTab({ dingtalkRpcCall, feishuRpcCall, weixinRpcCall }) {
  const [selected, setSelected] = React4.useState("weixin");
  ...
  return h4(
    ...
    h4(
      "header",
      { className: "dim-title" },
      h4("p", null, "\u901A\u8FC7\u626B\u7801\u628A\u673A\u5668\u4EBA\u63A5\u5165 DeepSeek Harness"),
      h4("div", { className: "dim-channelCount" }, `${CHANNELS.length} \u4E2A\u6E20\u9053`)
    ),
    h4(
      "div",
      ...
      h4(
        ...
        CHANNELS.map((channel) => h4(
          ...
          h4(ChannelLogo, { channel: channel.id }),
          h4(
            "span",
            { className: "dim-channelCopy" },
            h4("strong", null, channel.label)
          )
        ))
      ),
      h4("div", { className: "dim-divider", "aria-hidden": "true" }),
      h4("main", {
        className: "dim-panel",
        role: "tabpanel",
        id: `dim-panel-${active.id}`,
        "aria-labelledby": `dim-tab-${active.id}`
      }, active.id === "weixin" ? h4(WeixinSettingsTab, { rpcCall: weixinRpcCall }) : active.id === "feishu" ? h4(FeishuSettingsTab, { rpcCall: feishuRpcCall }) : h4(DingtalkSettingsTab, { rpcCall: dingtalkRpcCall }))
    )
  );
}
function apply(ctx) {
