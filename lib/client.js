...
function CredentialBindingPanel({
  ...
  return h2(
    ...
    h2(
      "form",
      { className: "dim-credentialForm", onSubmit: submit },
      h2(
        "label",
...
function useAnimationFrameScheduler() {
  const schedulerRef = React4.useRef(null);
  React4.useEffect(() => {
...
function QrIcon({ size = 58 }) {
  return h4(SvgIcon, { size }, h4("path", {
    d: "M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h2v2h-2v-2Zm4 0h2v4h-2v-4Zm-4 4h4v2h-4v-2Z",
    fill: "currentColor"
  }));
}
var Button3 = React5.forwardRef(function Button4({ children, kind = "secondary", size, icon, className = "", ...props }, ref) {
  return h4("button", {
    ...props,
    ref,
    type: "button",
    ...
    "data-kind": kind,
    "data-size": size
  }, icon, h4("span", null, children));
});
function BrandMark() {
  return h4("div", { className: "bxf-brandMark" }, h4(RobotIcon, { size: 34 }));
}
function Heading2({ totals, onAdd, onCredential, credentialOpen, adding, busy, addButtonRef }) {
  ...
  return h4(
    ...
    h4(
      ...
      }, h4("span", null, `${totals.connected} / ${totals.configured} \u5728\u7EBF`)) : null
    )
  );
}
function LoadingView2() {
  return h4(
    ...
    h4("div", { className: "dim-spinner", "aria-hidden": "true" }),
    h4("span", null, "\u6B63\u5728\u8BFB\u53D6\u98DE\u4E66\u8FDE\u63A5\u72B6\u6001\u2026")
  );
}
    ...
    h4(
      ...
      h4(
        ...
        h4(
          ...
          h4("span", { className: "bxf-dot dim-stateDot" }),
          h4("span", null, "\u5C1A\u672A\u63A5\u5165\u673A\u5668\u4EBA")
        ),
        h4("h3", null, "\u626B\u7801\uFF0C\u521B\u5EFA\u7B2C\u4E00\u4E2A\u98DE\u4E66\u5165\u53E3"),
        h4("p", null, "\u65E0\u9700\u624B\u52A8\u586B\u5199 App ID\u3002\u4EE5\u540E\u8FD8\u53EF\u4EE5\u7EE7\u7EED\u6DFB\u52A0\u673A\u5668\u4EBA\uFF0C\u5206\u522B\u670D\u52A1\u4E0D\u540C\u56E2\u961F\u6216\u98DE\u4E66\u79DF\u6237\u3002"),
        h4(
          "div",
      ...
      h4("div", { className: "bxf-markStage dim-emptyBrand", "aria-hidden": "true" }, h4(BrandMark))
    )
  );
}
...
function QrPane({ provision, now, onRefresh, onCancel, busy }) {
  ...
  React5.useEffect(() => setImageFailed(false), [qrSource]);
  return h4(
    "div",
      ...
      h4(
        ...
        h4(
          ...
          qrSource && !imageFailed ? h4("img", {
            ...
            h4("div", null, h4(QrIcon), h4("span", null, "\u4E8C\u7EF4\u7801\u672A\u5C31\u7EEA\uFF0C\u8BF7\u6253\u5F00\u6388\u6743\u94FE\u63A5"))
          ),
          expired ? h4(
            "div",
            { className: "bxf-expiredOverlay dim-qrExpired", role: "status" },
            h4("div", null, "\u4E8C\u7EF4\u7801\u5DF2\u5931\u6548", h4("br"), "\u8BF7\u5237\u65B0\u540E\u91CD\u65B0\u626B\u7801")
          ) : null
        ),
        h4(
          "div",
          ...
          h4(
            ...
            h4("span", null, expired ? "\u7B49\u5F85\u5237\u65B0" : "\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"),
            h4("strong", null, formatRemaining2(remaining))
          ),
          h4(
            "div",
            { className: "bxf-progress dim-progress", "aria-hidden": "true" },
            h4("span", { style: { "--bxf-progress": `${Math.round(progress * 100)}%` } })
          )
        )
      ),
      h4(
        ...
        h4(
          "div",
          { className: "bxf-stateLabel dim-stateLabel" },
          h4("span", { className: "bxf-dot dim-stateDot", "data-tone": "warning" }),
          h4("span", null, "\u6B63\u5728\u6DFB\u52A0\u65B0\u673A\u5668\u4EBA")
        ),
        h4("h3", null, expired ? "\u5237\u65B0\u4E8C\u7EF4\u7801\u540E\u7EE7\u7EED" : "\u4F7F\u7528\u98DE\u4E66\u626B\u7801\u521B\u5EFA\u673A\u5668\u4EBA"),
        h4("p", null, "\u626B\u7801\u53EA\u4F1A\u65B0\u589E\u4E00\u4E2A\u673A\u5668\u4EBA\uFF0C\u5DF2\u63A5\u5165\u7684\u673A\u5668\u4EBA\u4F1A\u7EE7\u7EED\u6B63\u5E38\u6536\u53D1\u6D88\u606F\u3002"),
        h4(
          "ol",
          { className: "bxf-steps dim-steps" },
          h4("li", null, "\u6253\u5F00\u98DE\u4E66\u79FB\u52A8\u7AEF\uFF0C\u4F7F\u7528\u626B\u4E00\u626B\u8BFB\u53D6\u4E8C\u7EF4\u7801"),
          h4("li", null, "\u6838\u5BF9\u5E94\u7528\u540D\u79F0\u4E0E\u6743\u9650\u8303\u56F4\uFF0C\u5E76\u786E\u8BA4\u521B\u5EFA"),
          h4("li", null, "\u4FDD\u6301\u672C\u9875\u6253\u5F00\uFF0C\u7B49\u5F85\u65B0\u673A\u5668\u4EBA\u7684\u957F\u8FDE\u63A5\u5C31\u7EEA")
        ),
        h4(
          "div",
          { className: "bxf-actions dim-viewActions" },
          expired ? h4(Button3, {
            ...
            onClick: onRefresh,
            disabled: busy
          }, busy ? "\u5237\u65B0\u4E2D\u2026" : "\u5237\u65B0\u4E8C\u7EF4\u7801") : href ? h4("a", {
            className: "bxf-button bxf-link",
            "data-kind": "secondary",
            href,
            target: "_blank",
            rel: "noopener noreferrer"
          }, h4("span", null, "\u5728\u98DE\u4E66\u4E2D\u6253\u5F00")) : null,
          !expired ? h4(Button3, { onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
          h4(Button3, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88\u6DFB\u52A0")
        )
      )
    )
  );
...
function ProvisionProgress({ phase, onCancel, busy }) {
  ...
  return h4(
    ...
    h4("div", { className: "dim-spinner", "aria-hidden": "true" }),
    h4("h3", null, connecting ? "\u5DF2\u786E\u8BA4\uFF0C\u6B63\u5728\u8FDE\u63A5\u65B0\u673A\u5668\u4EBA" : "\u6B63\u5728\u51C6\u5907\u6388\u6743\u4E8C\u7EF4\u7801"),
    h4("p", null, connecting ? "\u6B63\u5728\u5B89\u5168\u4FDD\u5B58\u51ED\u636E\u5E76\u68C0\u67E5\u65B0\u673A\u5668\u4EBA\u7684\u6D88\u606F\u901A\u9053\uFF0C\u5176\u4ED6\u673A\u5668\u4EBA\u4E0D\u4F1A\u4E2D\u65AD\u3002" : "\u6B63\u5728\u5411\u98DE\u4E66\u7533\u8BF7\u4E00\u6B21\u6027\u6388\u6743\u4E8C\u7EF4\u7801\uFF0C\u8BF7\u7A0D\u5019\u3002"),
    connecting ? h4(
      "div",
  ...
  return h4(
    ...
    h4(
      ...
      h4(
        "div",
        null,
        h4("h3", null, "\u65B0\u673A\u5668\u4EBA\u6CA1\u6709\u6DFB\u52A0\u5B8C\u6210"),
        h4("p", null, error.message),
        error.code ? h4("span", { className: "bxf-errorCode" }, error.code) : null,
        h4(
          "div",
          { className: "bxf-actions dim-viewActions" },
          h4(
          ...
          h4(Button3, { onClick: onCancel, disabled: busy }, "\u5173\u95ED")
        )
      )
    )
  );
...
function RemoveConfirmation2({ bot, busy, onConfirm, onCancel }) {
  ...
  React5.useEffect(() => cancelRef.current?.focus(), []);
  return h4(
    "div",
    {
    ...
    h4("h4", { id: titleId }, `\u4ECE DeepSeek Harness \u79FB\u9664\u201C${bot.bot.name}\u201D\uFF1F`),
    h4(
      "p",
      { id: descriptionId },
    ...
    h4(
      "div",
      { className: "bxf-actions dim-viewActions" },
      h4(Button3, { ref: cancelRef, onClick: onCancel, disabled: busy }, "\u4FDD\u7559\u673A\u5668\u4EBA"),
      h4(
        Button3,
        { kind: "danger", onClick: onConfirm, disabled: busy },
        busy ? "\u6B63\u5728\u79FB\u9664\u2026" : "\u786E\u8BA4\u79FB\u9664\u63A5\u5165"
...
function BotCard({
  ...
  return h4(
      ...
      h4(
        ...
        h4(
          ...
          h4(
            ...
            h4(FeishuLogoGlyph, { size: 34 })
          ),
          h4(
            "div",
            { className: "bxf-botName dim-botName" },
            h4("h3", { id: titleId, title: bot.name }, bot.name),
            h4("p", { title: bot.appIdMasked }, bot.appIdMasked ?? "\u5E94\u7528\u6807\u8BC6\u5DF2\u5B89\u5168\u4FDD\u5B58")
          )
        ),
        h4(
          "div",
          { className: "bxf-healthPill dim-botHealth", "data-health": stateForDisplay },
          h4("span", { className: "bxf-dot dim-healthDot", "data-tone": tone }),
          h4("span", null, HEALTH_LABELS[stateForDisplay] ?? "\u72B6\u6001\u672A\u77E5")
        )
      ),
      h4(
        "dl",
        ...
        h4(
          ...
          h4("dt", null, "\u6D88\u606F\u901A\u9053"),
          h4("dd", null, connected ? "\u957F\u8FDE\u63A5" : stateForDisplay === "connecting" ? "\u8FDE\u63A5\u4E2D" : "\u5DF2\u65AD\u5F00")
        ),
        h4(
          "div",
          { className: "bxf-metric dim-botMetric" },
          h4("dt", null, "\u6700\u8FD1\u68C0\u67E5"),
          h4("dd", null, formatCheckedTime(health.lastCheckedAt))
        )
      ),
      h4(
        "div",
    ...
    removing ? h4(RemoveConfirmation2, {
      bot: connection,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function BotList(props) {
  return h4(
    ...
    h4(
      ...
      h4("h3", { id: "bxf-bot-list-title" }, "\u5DF2\u63A5\u5165\u7684\u673A\u5668\u4EBA")
    ),
    h4(
      "ul",
      { className: "bxf-botList dim-botList", role: "list" },
      props.bots.map((bot) => h4(
        "li",
        { key: bot.botId },
        h4(BotCard, {
          connection: bot,
...
function FeishuSettingsTab({ rpcCall }) {
  ...
  const [pageBusy, setPageBusy] = React5.useState(false);
  const [provisionBusy, setProvisionBusy] = React5.useState(false);
  const [credentialOpen, setCredentialOpen] = React5.useState(false);
  const [credentialBusy, setCredentialBusy] = React5.useState(false);
  const [credentialError, setCredentialError] = React5.useState(null);
  const [busyByBot, setBusyByBot] = React5.useState({});
  const [errorsByBot, setErrorsByBot] = React5.useState({});
  const [removeTargetId, setRemoveTargetId] = React5.useState(null);
  const [announcement, setAnnouncement] = React5.useState("");
  const [now, setNow] = React5.useState(() => Date.now());
  const [focusBotId, setFocusBotId] = React5.useState(null);
  const cardRefs = React5.useRef(/* @__PURE__ */ new Map());
  const removeButtonRefs = React5.useRef(/* @__PURE__ */ new Map());
  const addButtonRef = React5.useRef(null);
  const scheduleAnimationFrame = useAnimationFrameScheduler();
  const announce = React5.useCallback((message) => {
    setAnnouncement("");
  ...
  const mergeSnapshot = React5.useCallback((snapshot, { restoreProvisioning = false } = {}) => {
    const now2 = Date.now();
  ...
  const loadStatus = React5.useCallback(async ({ signal, silent = false, restoreProvisioning = false } = {}) => {
  ...
  const bindCredentials = React5.useCallback(async ({ identity, secret }) => {
  ...
  const setBotError = React5.useCallback((botId, error) => {
  ...
  const reconnectOneBot = React5.useCallback(async (connection) => {
  ...
  const requestRemove = React5.useCallback((connection) => {
    setRemoveTargetId(connection.botId);
  }, []);
  const cancelRemove = React5.useCallback(() => {
  ...
  const confirmRemove = React5.useCallback(async (connection) => {
    const { botId, bot } = connection;
  ...
  if (provision?.phase === "creating") {
    provisionContent = h4(ProvisionProgress, { phase: "creating", busy: provisionBusy });
  } else if (provision?.phase === "qr") {
    provisionContent = h4(QrPane, {
      provision,
      now,
      onRefresh: () => void startProvisioning({ replace: true }),
      onCancel: () => void cancelProvisioning(),
    ...
    provisionContent = h4(ProvisionProgress, {
      phase: "connecting",
      onCancel: () => void cancelProvisioning(),
      busy: provisionBusy
    });
  } else if (provision?.phase === "error") {
    provisionContent = h4(ProvisionError2, {
  ...
  const credentialContent = credentialOpen ? h4(CredentialBindingPanel, {
    channel: "\u98DE\u4E66",
  ...
  const setCardRef = React5.useCallback((botId, node) => {
    if (node) cardRefs.current.set(botId, node);
    else cardRefs.current.delete(botId);
  }, []);
  const setRemoveButtonRef = React5.useCallback((botId, node) => {
  ...
  return h4(
    ...
    model.statusError ? h4(
      "div",
      { className: "bxf-statusNotice dim-statusNotice", role: "status" },
      h4(AlertIcon, { size: 16 }),
      h4("span", null, `\u72B6\u6001\u81EA\u52A8\u5237\u65B0\u5931\u8D25\uFF1A${model.statusError.message}`),
      h4(Button3, { size: "small", onClick: () => void loadStatus({ silent: true }), disabled: pageBusy }, "\u7ACB\u5373\u91CD\u8BD5")
    ) : null,
    model.phase === "loading" ? h4(LoadingView2) : model.phase === "error" ? h4(PageError, {
      ...
      credentialContent,
      provisionContent,
      model.bots.length === 0 && !provision && !credentialOpen ? h4(EmptyView2, { onStart: () => void startProvisioning(), busy: provisionBusy }) : null,
      model.bots.length > 0 ? h4(BotList, {
        bots: model.bots,
        busyByBot,
        errorsByBot,
        removeTargetId,
...
var Button5 = React6.forwardRef(function Button6({ children, kind = "secondary", className = "", ...props }, ref) {
  return h5("button", {
    ...props,
    ref,
    type: "button",
  ...
  return h5(
    ...
    h5(
      ...
      h5(
        ...
        }, h5(QrActionIcon), adding ? "\u6B63\u5728\u63A5\u5165" : "\u626B\u7801\u63A5\u5165\u673A\u5668\u4EBA"),
        h5(Button5, {
          kind: "credential",
          className: "dim-credentialButton",
          onClick: onCredential,
        ...
        }, h5(CredentialActionIcon), credentialOpen ? "\u6536\u8D77\u51ED\u636E" : "\u624B\u52A8\u63A5\u5165")
      ),
      totals.configured > 0 ? h5(
        "div",
        { className: "ddt-badge dim-onlineBadge" },
        h5("span", null, `${totals.connected} / ${totals.configured} \u5728\u7EBF`)
      ) : null
    )
  );
}
function LoadingView3() {
  return h5(
    "div",
    { className: "ddt-card ddt-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" },
    h5("div", { className: "ddt-spinner dim-spinner" }),
    h5("span", null, "\u6B63\u5728\u8BFB\u53D6 QQ \u673A\u5668\u4EBA\u72B6\u6001\u2026")
  );
}
    ...
    h5(
      ...
      h5(
        ...
        h5(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h5("span", { className: "ddt-dot dim-stateDot" }),
          h5("span", null, "\u5C1A\u672A\u7ED1\u5B9A QQ \u673A\u5668\u4EBA")
        ),
        h5("h3", null, "\u4F7F\u7528\u624B\u673A QQ \u626B\u7801\u521B\u5EFA\u5E76\u7ED1\u5B9A\u673A\u5668\u4EBA"),
        h5("p", null, "\u626B\u7801\u7531\u817E\u8BAF\u5B98\u65B9\u9875\u9762\u5B8C\u6210\uFF0C\u4E0D\u9700\u8981\u624B\u52A8\u586B\u5199 AppID \u6216 AppSecret\u3002\u626B\u7801\u6210\u529F\u540E\uFF0C\u673A\u5668\u4EBA\u4F1A\u81EA\u52A8\u8FDE\u63A5 DeepSeek Harness\u3002"),
        h5(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h5(
    ...
    h5(
      ...
      h5(
        ...
        h5(
          "div",
          { className: "ddt-qrFrame dim-qrFrame" },
          source ? h5("img", { src: source, alt: "\u7528\u4E8E\u7ED1\u5B9A QQ \u673A\u5668\u4EBA\u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801" }) : h5(
            "div",
        ...
        h5(
          ...
          h5(
            "div",
            { className: "ddt-countdownTop dim-countdownTop" },
            h5("span", null, "\u5F53\u524D\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"),
            h5("strong", null, refreshing ? "--:--" : formatRemaining3(remaining))
          ),
          h5("div", { className: "ddt-progress dim-progress", style: { "--ddt-progress": `${progress}%` } }, h5("span"))
        )
      ),
      h5(
        "div",
        ...
        h5(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h5("span", { className: "ddt-dot dim-stateDot", "data-tone": "warning" }),
          h5("span", null, refreshing ? "\u6B63\u5728\u5237\u65B0\u4E8C\u7EF4\u7801" : "\u7B49\u5F85\u624B\u673A QQ \u626B\u7801")
        ),
        h5("h3", null, "\u4F7F\u7528\u624B\u673A QQ \u5B8C\u6210\u673A\u5668\u4EBA\u7ED1\u5B9A"),
        h5("p", null, "\u817E\u8BAF\u9875\u9762\u4F1A\u521B\u5EFA\u6216\u7ED1\u5B9A\u4E00\u4E2A QQ \u673A\u5668\u4EBA\uFF0C\u5E76\u628A\u8FDE\u63A5\u51ED\u636E\u5B89\u5168\u4EA4\u7ED9\u672C\u673A Harness Host\u3002"),
        h5(
          "ol",
          { className: "ddt-steps dim-steps" },
          h5("li", null, "\u6253\u5F00\u624B\u673A QQ\uFF0C\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h5("li", null, "\u5728\u817E\u8BAF\u6388\u6743\u9875\u9762\u786E\u8BA4\u521B\u5EFA\u6216\u7ED1\u5B9A\u673A\u5668\u4EBA"),
          h5("li", null, "\u8FD4\u56DE\u8FD9\u91CC\u7B49\u5F85\u8FDE\u63A5\u5B8C\u6210")
        ),
        h5(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h5(Button5, { onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
          h5(Button5, { kind: "quiet", onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function ProvisionView({ provision, busy, onRetry, onClose }) {
  if (provision.status === "connecting") {
    return h5(
      ...
      h5("div", { className: "ddt-spinner dim-spinner" }),
      h5("h3", null, "QQ \u5DF2\u6388\u6743\uFF0C\u6B63\u5728\u8FDE\u63A5\u673A\u5668\u4EBA"),
      h5("p", null, "\u51ED\u636E\u6B63\u5728\u5199\u5165\u672C\u673A\uFF0C\u5E76\u542F\u52A8 QQ WebSocket \u6D88\u606F\u8FDE\u63A5\u3002")
    );
  }
  ...
  return h5(
    ...
    h5(
      "div",
      { className: "ddt-inlineError dim-inlineError", role: "alert" },
      h5("h3", null, "QQ \u673A\u5668\u4EBA\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h5("p", null, error.message),
      h5("span", { className: "ddt-errorCode" }, error.code),
      h5(
        "div",
        { className: "ddt-actions dim-viewActions" },
        h5(Button5, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h5(Button5, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
function RemoveConfirmation3({ account, busy, onConfirm, onCancel }) {
  return h5(
    ...
    h5("strong", null, `\u4ECE DeepSeek Harness \u79FB\u9664\u201C${account.bot.name}\u201D\uFF1F`),
    h5("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684\u5E94\u7528\u51ED\u636E\u3001\u673A\u5668\u4EBA\u914D\u7F6E\u53CA\u4F1A\u8BDD\u6620\u5C04\u3002\u817E\u8BAF\u5E73\u53F0\u4E2D\u7684\u673A\u5668\u4EBA\u4E0D\u4F1A\u88AB\u81EA\u52A8\u5220\u9664\u3002"),
    h5(
      "div",
      { className: "ddt-actions dim-viewActions" },
      h5(Button5, { onClick: onCancel, disabled: busy }, "\u4FDD\u7559\u673A\u5668\u4EBA"),
      h5(Button5, { kind: "danger", onClick: onConfirm, disabled: busy }, busy ? "\u6B63\u5728\u79FB\u9664\u2026" : "\u786E\u8BA4\u79FB\u9664\u63A5\u5165")
    )
  );
}
    ...
    h5(
      ...
      h5(
        ...
        h5(
          "div",
          { className: "ddt-accountIdentity dim-botIdentity" },
          h5("div", { className: "ddt-avatar dim-botAvatar dqq-avatar", "aria-hidden": "true" }, h5(QqLogoGlyph, { size: 29 })),
          h5(
            "div",
            { className: "dim-botName" },
            h5("h3", null, account.bot.name),
            h5("p", null, account.bot.appIdMasked)
          )
        ),
        h5(
          "div",
          { className: "ddt-health dim-botHealth" },
          h5("span", { className: "ddt-dot dim-healthDot", "data-tone": tone }),
          h5("span", null, stateLabel)
        )
      ),
      h5(
        "dl",
        { className: "ddt-metrics dim-botMetrics" },
        h5("div", { className: "ddt-metric dim-botMetric" }, h5("dt", null, "\u6D88\u606F\u901A\u9053"), h5("dd", null, account.connected ? "WebSocket \u957F\u8FDE\u63A5" : "\u79BB\u7EBF")),
        h5("div", { className: "ddt-metric dim-botMetric" }, h5("dt", null, "\u6700\u8FD1\u68C0\u67E5"), h5("dd", null, checkedTime2(account.health.lastCheckedAt)))
      ),
      h5(
        "div",
        { className: "ddt-accountFooter dim-cardFooter" },
        summary ? h5("div", { className: "ddt-summary dim-cardSummary" }, summary) : null,
        h5(
          "div",
          { className: "ddt-actions dim-cardActions" },
          h5(Button5, { className: "dim-cardAction", onClick: onReconnect, disabled: Boolean(busy) }, busy === "reconnect" ? "\u68C0\u67E5\u4E2D\u2026" : account.connected ? "\u68C0\u67E5\u8FDE\u63A5" : "\u91CD\u8BD5\u8FDE\u63A5"),
          h5(Button5, { className: "dim-cardAction", kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h5(RemoveConfirmation3, {
      account,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function QqSettingsTab({ rpcCall }) {
  const [model, setModel] = React6.useState({ phase: "loading", bots: [], totals: { configured: 0, connected: 0 }, error: null });
  ...
  const mounted = React6.useRef(true);
  ...
  const loadStatus = React6.useCallback(async ({ signal, silent = false, restore = false } = {}) => {
  ...
  const closeProvision = React6.useCallback(async () => {
    setBusy(true);
    try {
  ...
  const botAction = React6.useCallback(async (account, operation, endpoint, payload) => {
  ...
  let provisionView = null;
  if (provision?.status === "starting") provisionView = h5("div", { className: "ddt-card ddt-loading dim-surfaceCard" }, h5("div", { className: "ddt-spinner" }), "\u6B63\u5728\u7533\u8BF7 QQ \u4E8C\u7EF4\u7801\u2026");
  else if (["pending", "refreshing"].includes(provision?.status)) provisionView = h5(QrPanel2, {
    provision,
    now,
    busy,
  ...
  else if (provision) provisionView = h5(ProvisionView, {
    provision,
    busy,
    onRetry: () => void startProvisioning(true),
    onClose: () => void closeProvision()
  });
  const botList = model.bots.length > 0 ? h5(
    "section",
    { className: "dim-listSection" },
    h5(
      "div",
      { className: "ddt-listHeading dim-listHeading" },
      h5("h3", null, "\u5DF2\u7ED1\u5B9A\u7684 QQ \u673A\u5668\u4EBA")
    ),
    h5("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h5("li", { key: account.botId }, h5(AccountCard2, {
      account,
  ...
  const credentialView = credentialOpen ? h5(CredentialBindingPanel, {
    channel: "QQ",
    identityLabel: "AppID",
  ...
  return h5(
    ...
    model.phase === "loading" ? h5(LoadingView3) : model.phase === "error" ? h5("div", { className: "ddt-card dim-surfaceCard" }, h5("div", { className: "ddt-inlineError dim-inlineError" }, h5("h3", null, "\u65E0\u6CD5\u8BFB\u53D6 QQ \u673A\u5668\u4EBA\u72B6\u6001"), h5("p", null, model.error?.message), h5(Button5, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6"))) : h5(
      React6.Fragment,
      null,
      credentialView,
      provisionView,
      model.bots.length === 0 && !provision && !credentialOpen ? h5(EmptyView3, { busy, onStart: () => void startProvisioning() }) : null,
      botList
    )
  );
}
    ...
    h6(
      ...
      h6(
        ...
        h6(
          ...
          h6("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA")
        ),
        h6("h3", null, "\u4F7F\u7528\u4F01\u4E1A\u5FAE\u4FE1 App \u626B\u7801\u521B\u5EFA\u667A\u80FD\u673A\u5668\u4EBA"),
        h6("p", null, "\u626B\u7801\u7531\u817E\u8BAF\u5B98\u65B9\u9875\u9762\u5B8C\u6210\uFF0C\u4E0D\u9700\u8981\u624B\u52A8\u586B\u5199 Bot ID \u6216 Secret\u3002\u521B\u5EFA\u6210\u529F\u540E\uFF0C\u673A\u5668\u4EBA\u4F1A\u81EA\u52A8\u8FDE\u63A5 DeepSeek Harness\u3002"),
        h6(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h6(
    ...
    h6(
      ...
      h6(
        ...
        h6(
          "div",
          { className: "ddt-qrFrame dim-qrFrame" },
          source ? h6("img", { src: source, alt: "\u7528\u4E8E\u7ED1\u5B9A\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801" }) : h6(
            "div",
            { className: "ddt-qrFallback dim-qrFallback" },
            refreshing ? "\u4E8C\u7EF4\u7801\u6B63\u5728\u81EA\u52A8\u5237\u65B0\u2026" : "\u4E8C\u7EF4\u7801\u56FE\u7247\u6B63\u5728\u751F\u6210\u2026"
          )
        ...
        h6(
          ...
          h6(
            ...
            h6("strong", null, refreshing ? "--:--" : formatRemaining4(remaining))
          ),
      ...
      h6(
        ...
        h6(
          ...
          h6("span", null, refreshing ? "\u6B63\u5728\u5237\u65B0\u4E8C\u7EF4\u7801" : "\u7B49\u5F85\u4F01\u4E1A\u5FAE\u4FE1 App \u626B\u7801")
        ),
        h6("h3", null, "\u4F7F\u7528\u4F01\u4E1A\u5FAE\u4FE1 App \u5B8C\u6210\u667A\u80FD\u673A\u5668\u4EBA\u6388\u6743"),
        h6("p", null, "\u4F01\u4E1A\u5FAE\u4FE1\u5B98\u65B9\u9875\u9762\u4F1A\u521B\u5EFA\u4E00\u4E2A\u667A\u80FD\u673A\u5668\u4EBA\uFF0C\u5E76\u628A\u8FDE\u63A5\u51ED\u636E\u5B89\u5168\u4EA4\u7ED9\u672C\u673A Harness Host\u3002"),
        h6(
          "ol",
          { className: "ddt-steps dim-steps" },
          h6("li", null, "\u6253\u5F00\u4F01\u4E1A\u5FAE\u4FE1 App\uFF0C\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h6("li", null, "\u5728\u817E\u8BAF\u6388\u6743\u9875\u9762\u786E\u8BA4\u521B\u5EFA\u667A\u80FD\u673A\u5668\u4EBA"),
...
function ProvisionView2({ provision, busy, onRetry, onClose }) {
  if (provision.status === "connecting") {
    return h6(
      ...
      { className: "ddt-card ddt-loading dim-surfaceCard dim-specialView", "aria-busy": "true" },
      h6("div", { className: "ddt-spinner dim-spinner" }),
      h6("h3", null, "\u4F01\u4E1A\u5FAE\u4FE1\u5DF2\u6388\u6743\uFF0C\u6B63\u5728\u8FDE\u63A5\u673A\u5668\u4EBA"),
      h6("p", null, "\u51ED\u636E\u6B63\u5728\u5199\u5165\u672C\u673A\uFF0C\u5E76\u542F\u52A8\u4F01\u4E1A\u5FAE\u4FE1 WebSocket \u6D88\u606F\u8FDE\u63A5\u3002")
    );
  }
...
function RemoveConfirmation4({ account, busy, onConfirm, onCancel }) {
  return h6(
    ...
    h6("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684\u5E94\u7528\u51ED\u636E\u3001\u673A\u5668\u4EBA\u914D\u7F6E\u53CA\u4F1A\u8BDD\u6620\u5C04\u3002\u4F01\u4E1A\u5FAE\u4FE1\u5E73\u53F0\u4E2D\u7684\u673A\u5668\u4EBA\u4E0D\u4F1A\u88AB\u81EA\u52A8\u5220\u9664\u3002"),
    h6(
      "div",
      { className: "ddt-actions dim-viewActions" },
...
function AccountCard3({ account, busy, removing, onReconnect, onRequestRemove, onConfirmRemove, onCancelRemove }) {
  ...
  return h6(
    ...
    h6(
      ...
      h6(
        ...
        h6(
          "div",
          { className: "ddt-accountIdentity dim-botIdentity" },
          h6("div", { className: "ddt-avatar dim-botAvatar dwecom-avatar", "aria-hidden": "true" }, h6(WecomLogoGlyph, { size: 29 })),
          h6(
            "div",
            { className: "dim-botName" },
    ...
    removing ? h6(RemoveConfirmation4, {
      account,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function WecomSettingsTab({ rpcCall }) {
  ...
  let provisionView = null;
  if (provision?.status === "starting") provisionView = h6("div", { className: "ddt-card ddt-loading dim-surfaceCard" }, h6("div", { className: "ddt-spinner" }), "\u6B63\u5728\u7533\u8BF7\u4F01\u4E1A\u5FAE\u4FE1\u4E8C\u7EF4\u7801\u2026");
  else if (["pending", "refreshing"].includes(provision?.status)) provisionView = h6(QrPanel3, {
    provision,
    now,
    busy,
    onRefresh: () => void startProvisioning(true),
  ...
  else if (provision) provisionView = h6(ProvisionView2, {
    provision,
    busy,
    onRetry: () => void startProvisioning(true),
    onClose: () => void closeProvision()
  ...
  const botList = model.bots.length > 0 ? h6(
    ...
    h6(
      "div",
      { className: "ddt-listHeading dim-listHeading" },
      h6("h3", null, "\u5DF2\u7ED1\u5B9A\u7684\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA")
    ),
    h6("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h6("li", { key: account.botId }, h6(AccountCard3, {
      account,
      busy: busyByBot[account.botId],
      removing: removeTarget === account.botId,
  ...
  return h6(
    ...
    model.phase === "loading" ? h6(LoadingView4) : model.phase === "error" ? h6("div", { className: "ddt-card dim-surfaceCard" }, h6("div", { className: "ddt-inlineError dim-inlineError" }, h6("h3", null, "\u65E0\u6CD5\u8BFB\u53D6\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u72B6\u6001"), h6("p", null, model.error?.message), h6(Button7, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6"))) : h6(
      React7.Fragment,
      null,
      credentialView,
      provisionView,
      model.bots.length === 0 && !provision && !credentialOpen ? h6(EmptyView4, { busy, onStart: () => void startProvisioning() }) : null,
      botList
    )
  );
}
...
function LoadingView5() {
  return h7(
    ...
    h7("div", { className: "dxw-spinner dim-spinner" }),
    h7("span", null, "\u6B63\u5728\u8BFB\u53D6\u5FAE\u4FE1\u8FDE\u63A5\u72B6\u6001\u2026")
  );
}
    ...
    h7(
      ...
      h7(
        ...
        h7(
          ...
          h7("span", { className: "dxw-dot dim-stateDot" }),
          h7("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u5FAE\u4FE1")
        ),
        h7("h3", null, "\u626B\u4E00\u6B21\u7801\uFF0C\u5C31\u80FD\u5728\u5FAE\u4FE1\u91CC\u4F7F\u7528 Harness"),
        h7("p", null, "\u4E8C\u7EF4\u7801\u7531\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u7B7E\u53D1\u3002\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u5E76\u786E\u8BA4\u540E\uFF0C\u8D26\u53F7\u51ED\u636E\u4F1A\u76F4\u63A5\u5199\u5165 Harness Host\uFF0C\u6D4F\u89C8\u5668\u4E0D\u4F1A\u6536\u5230 bot_token\u3002"),
        h7(
          "div",
      ...
      h7("div", { className: "dxw-logo dim-emptyBrand", "aria-hidden": "true" }, h7(WeixinLogoGlyph, { size: 64 }))
    )
  );
}
    ...
    h7(
      ...
      h7(
        ...
        h7(
          ...
          source && !imageFailed ? h7("img", {
            src: source,
            alt: "\u7528\u4E8E\u628A\u5FAE\u4FE1\u673A\u5668\u4EBA\u7ED1\u5B9A\u5230 DeepSeek Harness \u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801",
            onError: () => setImageFailed(true)
          }) : h7("div", { className: "dxw-qrFallback dim-qrFallback" }, "\u4E8C\u7EF4\u7801\u56FE\u7247\u672A\u5C31\u7EEA\uFF0C\u8BF7\u4F7F\u7528\u5907\u7528\u94FE\u63A5\u3002"),
          expired ? h7("div", { className: "dxw-expired dim-qrExpired" }, "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F\n\u8BF7\u91CD\u65B0\u751F\u6210") : null
        ),
        h7(
          "div",
          { className: "dxw-countdown dim-countdown" },
          h7("div", { className: "dim-countdownTop" }, h7("span", null, "\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"), h7("strong", null, formatRemaining5(remaining))),
          h7(
            "div",
            { className: "dxw-progress dim-progress", "aria-hidden": "true" },
            h7("span", { style: { "--dxw-progress": `${progress}%` } })
          )
        )
      ),
      h7(
        ...
        h7(
          "div",
          { className: "dxw-stateLabel dim-stateLabel" },
          h7("span", { className: "dxw-dot dim-stateDot", "data-tone": provision.status === "scanned" ? "success" : "warning" }),
          h7("span", null, provision.status === "scanned" ? "\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4" : "\u7B49\u5F85\u5FAE\u4FE1\u626B\u7801")
        ),
        h7("h3", null, expired ? "\u4E8C\u7EF4\u7801\u5DF2\u5931\u6548" : "\u4F7F\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u4E8C\u7EF4\u7801"),
        h7("p", null, "\u8BF7\u5728\u624B\u673A\u4E0A\u6838\u5BF9\u5E76\u786E\u8BA4\u6388\u6743\u3002\u90E8\u5206\u8D26\u53F7\u4F1A\u989D\u5916\u663E\u793A\u4E00\u4E2A\u914D\u5BF9\u6570\u5B57\uFF0C\u9875\u9762\u4F1A\u5728\u9700\u8981\u65F6\u63D0\u793A\u8F93\u5165\u3002"),
        h7(
          "ol",
          { className: "dxw-steps dim-steps" },
          h7("li", null, "\u6253\u5F00\u624B\u673A\u5FAE\u4FE1\u5E76\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h7("li", null, "\u5728\u5FAE\u4FE1\u4E2D\u786E\u8BA4\u8FDE\u63A5\u8BE5\u673A\u5668\u4EBA"),
          h7("li", null, "\u4FDD\u6301\u672C\u9875\u6253\u5F00\uFF0C\u7B49\u5F85\u6D88\u606F\u957F\u8F6E\u8BE2\u53D8\u4E3A\u5728\u7EBF")
        ),
        h7(
          "div",
          { className: "dxw-actions dim-viewActions" },
          expired ? h7(Button9, { kind: "primary", onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801") : null,
          href ? h7("a", {
          ...
          !expired ? h7(Button9, { onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
          h7(Button9, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function VerificationPanel({ provision, busy, onSubmit, onCancel }) {
  ...
  React8.useEffect(() => setCode(""), [provision.attemptId]);
  return h7(
    "div",
    { className: "dxw-card dim-surfaceCard" },
    h7(
      ...
      h7(
        ...
        h7("span", { className: "dxw-dot", "data-tone": "warning" }),
        h7("span", null, "\u9700\u8981\u914D\u5BF9\u7801")
      ),
      h7("h3", null, "\u8F93\u5165\u624B\u673A\u5FAE\u4FE1\u663E\u793A\u7684\u6570\u5B57"),
      h7("p", null, "\u8FD9\u662F\u5FAE\u4FE1\u9644\u52A0\u7684\u5B89\u5168\u786E\u8BA4\u6B65\u9AA4\u3002\u914D\u5BF9\u7801\u53EA\u7528\u4E8E\u672C\u6B21\u626B\u7801\u8F6E\u8BE2\uFF0C\u4E0D\u4F1A\u5199\u5165\u914D\u7F6E\u6216\u65E5\u5FD7\u3002"),
      h7(
        "div",
      ...
      h7(Button9, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88\u7ED1\u5B9A")
    )
  );
}
function ProgressPanel2({ scanned, onCancel, busy }) {
  return h7(
    ...
    { className: "dxw-card dxw-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" },
    h7("div", { className: "dxw-spinner dim-spinner" }),
    h7("h3", null, scanned ? "\u5FAE\u4FE1\u5DF2\u786E\u8BA4\uFF0C\u6B63\u5728\u542F\u52A8\u6D88\u606F\u8FDE\u63A5" : "\u6B63\u5728\u51C6\u5907\u5FAE\u4FE1\u4E8C\u7EF4\u7801"),
    h7("p", null, scanned ? "\u6B63\u5728\u4FDD\u5B58\u51ED\u636E\u5E76\u9A8C\u8BC1 Harness \u4E0E\u5FAE\u4FE1\u957F\u8F6E\u8BE2\u3002" : "\u6B63\u5728\u8054\u7CFB\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u3002"),
    onCancel ? h7(
      "div",
...
function ProvisionError3({ provision, busy, onRetry, onClose }) {
  ...
  return h7(
    ...
    h7(
      ...
      h7("h3", null, provision.status === "expired" ? "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F" : "\u5FAE\u4FE1\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h7("p", null, error.message),
      h7("span", { className: "dxw-errorCode" }, error.code),
      h7(
        "div",
        { className: "dxw-actions dim-viewActions" },
...
function AccountCard4({ account, busy, removing, onReconnect, onRequestRemove, onConfirmRemove, onCancelRemove }) {
  ...
  return h7(
    ...
    h7(
      ...
      h7(
        ...
        h7(
          ...
          h7("div", { className: "dxw-avatar dim-botAvatar", "aria-hidden": "true" }, h7(WeixinLogoGlyph, { size: 27 })),
          h7("div", { className: "dim-botName" }, h7("h3", null, account.bot.name), h7("p", null, account.bot.accountIdMasked))
        ),
        h7(
          "div",
          { className: "dxw-health dim-botHealth" },
          h7("span", { className: "dxw-dot dim-healthDot", "data-tone": tone }),
          h7("span", null, account.connected ? "\u8FD0\u884C\u6B63\u5E38" : state === "connecting" ? "\u6B63\u5728\u8FDE\u63A5" : "\u8FDE\u63A5\u672A\u5C31\u7EEA")
        )
      ),
      h7(
        "dl",
        ...
        h7(
          ...
          h7("dt", null, "\u6D88\u606F\u901A\u9053"),
          h7("dd", null, account.connected ? "iLink \u957F\u8F6E\u8BE2" : "\u79BB\u7EBF")
        ),
        h7(
          "div",
          { className: "dxw-metric dim-botMetric" },
          h7("dt", null, "\u6700\u8FD1\u68C0\u67E5"),
          h7("dd", null, checkedTime4(account.health.lastCheckedAt))
        )
      ),
      h7(
        "div",
        { className: "dxw-accountFooter dim-cardFooter" },
        summary ? h7("div", { className: "dxw-summary dim-cardSummary" }, summary) : null,
        h7(
          "div",
    ...
    removing ? h7(
      ...
      h7("strong", null, "\u4ECE\u6B64 Harness \u79FB\u9664\u8FD9\u4E2A\u5FAE\u4FE1\u8D26\u53F7\uFF1F"),
      h7("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684 bot_token\u3001\u8D26\u53F7\u914D\u7F6E\u548C\u4F1A\u8BDD\u6620\u5C04\u3002\u5176\u4ED6\u5FAE\u4FE1\u8D26\u53F7\u4E0D\u53D7\u5F71\u54CD\u3002"),
      h7(
        "div",
        { className: "dxw-actions dim-viewActions" },
        h7(Button9, { onClick: onCancelRemove, disabled: busy === "delete" }, "\u4FDD\u7559\u8D26\u53F7"),
        h7(
          Button9,
...
function AccountList2(props) {
  return h7(
    "section",
    { className: "dim-listSection" },
    h7("div", { className: "dxw-listHeading dim-listHeading" }, h7("h3", null, "\u5DF2\u63A5\u5165\u7684\u5FAE\u4FE1\u8D26\u53F7")),
    h7("ul", { className: "dxw-list dim-botList" }, props.bots.map((account) => h7(
      "li",
      { key: account.botId },
      h7(AccountCard4, {
        account,
...
function WeixinSettingsTab({ rpcCall }) {
  ...
  const scheduleAnimationFrame = useAnimationFrameScheduler();
  const announce = React8.useCallback((value) => {
    setNotice("");
    scheduleAnimationFrame(() => {
  ...
  const submitVerification = React8.useCallback(async (verifyCode) => {
  ...
  const setBotBusy = React8.useCallback((botId, value) => {
    setBusyByBot((current) => {
      const next = { ...current };
      if (value) next[botId] = value;
      else delete next[botId];
  ...
  const reconnect = React8.useCallback(async (account) => {
  ...
  let provisionView = null;
  if (provision?.status === "starting") {
    provisionView = h7(ProgressPanel2, { busy });
  } else if (["pending", "scanned"].includes(provision?.status)) {
    provisionView = h7(QrPanel4, {
      provision,
      now,
      busy,
      onRefresh: () => void startProvisioning({ replace: true }),
    ...
    provisionView = h7(VerificationPanel, {
      provision,
      busy,
    ...
    provisionView = h7(ProgressPanel2, {
      scanned: true,
      busy,
      onCancel: () => void cancelProvisioning()
    });
  } else if (provision && ["failed", "expired", "cancelled"].includes(provision.status)) {
    provisionView = h7(ProvisionError3, {
      provision,
      busy,
      onRetry: () => void startProvisioning({ replace: Boolean(provision.attemptId) }),
      onClose: () => void cancelProvisioning()
  ...
  return h7(
    ...
    h7("div", { className: "dxw-visuallyHidden", role: "status", "aria-live": "polite" }, notice),
    model.error && model.phase === "ready" ? h7("div", { className: "dxw-statusNotice dim-statusNotice" }, `\u72B6\u6001\u5237\u65B0\u5931\u8D25\uFF1A${model.error.message}`) : null,
    model.phase === "loading" ? h7(LoadingView5) : model.phase === "error" ? h7(
      "div",
      { className: "dxw-card dim-surfaceCard" },
      h7(
        "div",
        ...
        h7("h3", null, "\u65E0\u6CD5\u8BFB\u53D6\u5FAE\u4FE1\u72B6\u6001"),
        h7("p", null, model.error?.message ?? "\u8BF7\u7A0D\u540E\u91CD\u8BD5"),
        h7(Button9, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6")
      )
    ) : h7(
      React8.Fragment,
      null,
      provisionView,
      model.bots.length === 0 && !provision ? h7(EmptyView5, { onStart: () => void startProvisioning(), busy }) : null,
      model.bots.length > 0 ? h7(AccountList2, {
        bots: model.bots,
        busyByBot,
        removeTarget,
        onReconnect: (account) => void reconnect(account),
...
function DingtalkLogo() {
  return h8(
    ...
    h8(DingtalkLogoGlyph)
  );
}
function QqLogo() {
  return h8("span", { className: "dim-logo dim-logoQq", "aria-hidden": "true" }, h8(QqLogoGlyph));
}
function WecomLogo() {
  return h8("span", { className: "dim-logo dim-logoWecom", "aria-hidden": "true" }, h8(WecomLogoGlyph));
}
function ChannelLogo({ channel }) {
  if (channel === "weixin") return h8(WeixinLogo);
  if (channel === "feishu") return h8(FeishuLogo);
  if (channel === "dingtalk") return h8(DingtalkLogo);
  if (channel === "wecom") return h8(WecomLogo);
  return h8(QqLogo);
}
function IMSettingsTab({ dingtalkRpcCall, feishuRpcCall, qqRpcCall, wecomRpcCall, weixinRpcCall }) {
  const [selected, setSelected] = React9.useState("weixin");
  ...
  return h8(
    ...
    h8(
      "header",
      { className: "dim-title" },
      h8("p", null, "\u901A\u8FC7\u626B\u7801\u628A\u673A\u5668\u4EBA\u63A5\u5165 DeepSeek Harness")
    ),
    h8(
      "div",
      ...
      h8(
        ...
        CHANNELS.map((channel) => h8(
          ...
          h8(ChannelLogo, { channel: channel.id }),
          h8(
            "span",
            { className: "dim-channelCopy" },
            h8("strong", null, channel.label)
          )
        ))
      ),
      h8("div", { className: "dim-divider", "aria-hidden": "true" }),
      h8("main", {
        className: "dim-panel",
        role: "tabpanel",
        id: `dim-panel-${active.id}`,
        "aria-labelledby": `dim-tab-${active.id}`
      }, active.id === "weixin" ? h8(WeixinSettingsTab, { rpcCall: weixinRpcCall }) : active.id === "feishu" ? h8(FeishuSettingsTab, { rpcCall: feishuRpcCall }) : active.id === "dingtalk" ? h8(DingtalkSettingsTab, { rpcCall: dingtalkRpcCall }) : active.id === "wecom" ? h8(WecomSettingsTab, { rpcCall: wecomRpcCall }) : h8(QqSettingsTab, { rpcCall: qqRpcCall }))
    )
  );
}
function apply(ctx) {
