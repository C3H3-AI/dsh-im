...
function LoadingView3() {
  return h4(
    ...
    h4("div", { className: "dxw-spinner dim-spinner" }),
    ...
    h4(
      ...
      h4(
        ...
        h4(
          ...
          h4("span", { className: "dxw-dot dim-stateDot" }),
          h4("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u5FAE\u4FE1")
        ),
      ...
      h4("div", { className: "dxw-logo dim-emptyBrand", "aria-hidden": "true" }, h4(WeixinLogoGlyph, { size: 64 }))
    )
  );
}
    ...
    h4(
      ...
      h4(
        ...
        h4(
          ...
          source && !imageFailed ? h4("img", {
            ...
            onError: () => setImageFailed(true)
          }) : h4("div", { className: "dxw-qrFallback dim-qrFallback" }, "\u4E8C\u7EF4\u7801\u56FE\u7247\u672A\u5C31\u7EEA\uFF0C\u8BF7\u4F7F\u7528\u5907\u7528\u94FE\u63A5\u3002"),
          expired ? h4("div", { className: "dxw-expired dim-qrExpired" }, "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F\n\u8BF7\u91CD\u65B0\u751F\u6210") : null
        ),
        h4(
          "div",
          { className: "dxw-countdown dim-countdown" },
          h4("div", { className: "dim-countdownTop" }, h4("span", null, "\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"), h4("strong", null, formatRemaining3(remaining))),
          h4(
            "div",
      ...
      h4(
        ...
        h4(
          "div",
          { className: "dxw-stateLabel dim-stateLabel" },
          h4("span", { className: "dxw-dot dim-stateDot", "data-tone": provision.status === "scanned" ? "success" : "warning" }),
    ...
    h4(
      ...
      h4(
        ...
        h4(
          ...
          h4("div", { className: "dxw-avatar dim-botAvatar", "aria-hidden": "true" }, h4(WeixinLogoGlyph, { size: 27 })),
          h4("div", { className: "dim-botName" }, h4("h3", null, account.bot.name), h4("p", null, account.bot.accountIdMasked))
        ),
        h4(
          "div",
          { className: "dxw-health dim-botHealth" },
          h4("span", { className: "dxw-dot dim-healthDot", "data-tone": tone }),
      ...
      h4(
        ...
        h4("div", { className: "dxw-summary dim-cardSummary" }, account.error?.message ?? account.health.summary),
        h4(
          "div",
...
function AccountList2(props) {
  return h4(
    "section",
    { className: "dim-listSection" },
    h4("div", { className: "dxw-listHeading dim-listHeading" }, h4("h3", null, "\u5DF2\u63A5\u5165\u7684\u5FAE\u4FE1\u8D26\u53F7"), h4("span", null, `${props.bots.length} \u4E2A`)),
    h4("ul", { className: "dxw-list dim-botList" }, props.bots.map((account) => h4(
      "li",
      { key: account.botId },
      h4(AccountCard2, {
        account,
...
function WeixinSettingsTab({ rpcCall }) {
  ...
  return h4(
    ...
    model.error && model.phase === "ready" ? h4("div", { className: "dxw-statusNotice dim-statusNotice" }, `\u72B6\u6001\u5237\u65B0\u5931\u8D25\uFF1A${model.error.message}`) : null,
